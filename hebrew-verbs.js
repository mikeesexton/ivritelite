...
function buildStarterVerbEntries() {
  return [
    ...
    createVerbEntry({
      ...
      regularity: "irregular",
      conjugation_mode: "curated",
      senses: [makeSense("to take down", null, false)],
      forms: makeForms(
        makePresent(
...
function buildRequestedVerbEntries() {
  const batch = [
    ...
    {
      id: "advanced-verb-lehasbir", lemma: "להסביר", lemma_niqqud: "לְהַסְבִּיר", root: ["ס", "ב", "ר"], binyan: "hifil", regularity: "regular", gloss: "to explain", difficulty_level: 3,
      present: [["מסביר", "מַסְבִּיר"], ["מסבירה", "מַסְבִּירָה"], ["מסבירים", "מַסְבִּירִים"], ["מסבירות", "מַסְבִּירוֹת"]],
      past: [["הסברתי", "הִסְבַּרְתִּי"], ["הסברת", "הִסְבַּרְתָּ"], ["הסברת", "הִסְבַּרְתְּ"], ["הסביר", "הִסְבִּיר"], ["הסבירה", "הִסְבִּירָה"], ["הסברנו", "הִסְבַּרְנוּ"], ["הסברתם", "הִסְבַּרְתֶּם"], ["הסברתן", "הִסְבַּרְתֶּן"], ["הסבירו", "הִסְבִּירוּ"]],
      future: [["אסביר", "אַסְבִּיר"], ["תסביר", "תַּסְבִּיר"], ["תסבירי", "תַּסְבִּירִי"], ["יסביר", "יַסְבִּיר"], ["תסביר", "תַּסְבִּיר"], ["נסביר", "נַסְבִּיר"], ["תסבירו", "תַּסְבִּירוּ"], ["יסבירו", "יַסְבִּירוּ"]],
      imperative: [["הסבר", "הַסְבֵּר"], ["הסבירי", "הַסְבִּירִי"], ["הסבירו", "הַסְבִּירוּ"]],
    },
    {
      id: "advanced-verb-lehamshikh", lemma: "להמשיך", lemma_niqqud: "לְהַמְשִׁיךְ", root: ["מ", "ש", "כ"], binyan: "hifil", regularity: "regular", gloss: "to continue", difficulty_level: 3,
      present: [["ממשיך", "מַמְשִׁיךְ"], ["ממשיכה", "מַמְשִׁיכָה"], ["ממשיכים", "מַמְשִׁיכִים"], ["ממשיכות", "מַמְשִׁיכוֹת"]],
      past: [["המשכתי", "הִמְשַׁכְתִּי"], ["המשכת", "הִמְשַׁכְתָּ"], ["המשכת", "הִמְשַׁכְּ"], ["המשיך", "הִמְשִׁיךְ"], ["המשיכה", "הִמְשִׁיכָה"], ["המשכנו", "הִמְשַׁכְנוּ"], ["המשכתם", "הִמְשַׁכְתֶּם"], ["המשכתן", "הִמְשַׁכְתֶּן"], ["המשיכו", "הִמְשִׁיכוּ"]],
      future: [["אמשיך", "אַמְשִׁיךְ"], ["תמשיך", "תַּמְשִׁיךְ"], ["תמשיכי", "תַּמְשִׁיכִי"], ["ימשיך", "יַמְשִׁיךְ"], ["תמשיך", "תַּמְשִׁיךְ"], ["נמשיך", "נַמְשִׁיךְ"], ["תמשיכו", "תַּמְשִׁיכוּ"], ["ימשיכו", "יַמְשִׁיכוּ"]],
      imperative: [["המשך", "הַמְשֵׁךְ"], ["המשיכי", "הַמְשִׁיכִי"], ["המשיכו", "הַמְשִׁיכוּ"]],
    },
    {
      id: "advanced-verb-lehaskim", lemma: "להסכים", lemma_niqqud: "לְהַסְכִּים", root: ["ס", "כ", "מ"], binyan: "hifil", regularity: "regular", gloss: "to agree", difficulty_level: 3,
      present: [["מסכים", "מַסְכִּים"], ["מסכימה", "מַסְכִּימָה"], ["מסכימים", "מַסְכִּימִים"], ["מסכימות", "מַסְכִּימוֹת"]],
      past: [["הסכמתי", "הִסְכַּמְתִּי"], ["הסכמת", "הִסְכַּמְתָּ"], ["הסכמת", "הִסְכַּמְתְּ"], ["הסכים", "הִסְכִּים"], ["הסכימה", "הִסְכִּימָה"], ["הסכמנו", "הִסְכַּמְנוּ"], ["הסכמתם", "הִסְכַּמְתֶּם"], ["הסכמתן", "הִסְכַּמְתֶּן"], ["הסכימו", "הִסְכִּימוּ"]],
      future: [["אסכים", "אַסְכִּים"], ["תסכים", "תַּסְכִּים"], ["תסכימי", "תַּסְכִּימִי"], ["יסכים", "יַסְכִּים"], ["תסכים", "תַּסְכִּים"], ["נסכים", "נַסְכִּים"], ["תסכימו", "תַּסְכִּימוּ"], ["יסכימו", "יַסְכִּימוּ"]],
      imperative: [["הסכם", "הַסְכֵּם"], ["הסכימי", "הַסְכִּימִי"], ["הסכימו", "הַסְכִּימוּ"]],
    },
    {
      id: "advanced-verb-lehaamin", lemma: "להאמין", lemma_niqqud: "לְהַאֲמִין", root: ["א", "מ", "נ"], binyan: "hifil", regularity: "irregular", gloss: "to believe", difficulty_level: 3,
      present: [["מאמין", "מַאֲמִין"], ["מאמינה", "מַאֲמִינָה"], ["מאמינים", "מַאֲמִינִים"], ["מאמינות", "מַאֲמִינוֹת"]],
      past: [["האמנתי", "הֶאֱמַנְתִּי"], ["האמנת", "הֶאֱמַנְתָּ"], ["האמנת", "הֶאֱמַנְתְּ"], ["האמין", "הֶאֱמִין"], ["האמינה", "הֶאֱמִינָה"], ["האמנו", "הֶאֱמַנּוּ"], ["האמנתם", "הֶאֱמַנְתֶּם"], ["האמנתן", "הֶאֱמַנְתֶּן"], ["האמינו", "הֶאֱמִינוּ"]],
      future: [["אאמין", "אַאֲמִין"], ["תאמין", "תַּאֲמִין"], ["תאמיני", "תַּאֲמִינִי"], ["יאמין", "יַאֲמִין"], ["תאמין", "תַּאֲמִין"], ["נאמין", "נַאֲמִין"], ["תאמינו", "תַּאֲמִינוּ"], ["יאמינו", "יַאֲמִינוּ"]],
      imperative: [["האמן", "הַאֲמֵן"], ["האמיני", "הַאֲמִינִי"], ["האמינו", "הַאֲמִינוּ"]],
    },
    {
      id: "advanced-verb-lehatchil", lemma: "להתחיל", lemma_niqqud: "לְהַתְחִיל", root: ["ת", "ח", "ל"], binyan: "hifil", regularity: "regular", gloss: "to start", difficulty_level: 3,
      present: [["מתחיל", "מַתְחִיל"], ["מתחילה", "מַתְחִילָה"], ["מתחילים", "מַתְחִילִים"], ["מתחילות", "מַתְחִילוֹת"]],
      past: [["התחלתי", "הִתְחַלְתִּי"], ["התחלת", "הִתְחַלְתָּ"], ["התחלת", "הִתְחַלְתְּ"], ["התחיל", "הִתְחִיל"], ["התחילה", "הִתְחִילָה"], ["התחלנו", "הִתְחַלְנוּ"], ["התחלתם", "הִתְחַלְתֶּם"], ["התחלתן", "הִתְחַלְתֶּן"], ["התחילו", "הִתְחילוּ"]],
      future: [["אתחיל", "אַתְחִיל"], ["תתחיל", "תַּתְחִיל"], ["תתחילי", "תַּתְחִילִי"], ["יתחיל", "יַתְחִיל"], ["תתחיל", "תַּתְחִיל"], ["נתחיל", "נַתְחִיל"], ["תתחילו", "תַּתְחִילוּ"], ["יתחילו", "יַתְחִילוּ"]],
      imperative: [["התחל", "הַתְחֵל"], ["התחילי", "הַתְחִילִי"], ["התחילו", "הַתְחִילוּ"]],
    },
    {
    ...
    },
    {
      ...
      past: [["הגעתי", "הִרְגַּעְתִּי"], ["הגעת", "הִרְגַּעְתָּ"], ["הגעת", "הִרְגַּעְתְּ"], ["הרגיע", "הִרְגִּיעַ"], ["הרגיעה", "הִרְגִּיעָה"], ["הרגנו", "הִרְגַּעְנוּ"], ["הרגתם", "הִרְגַּעְתֶּם"], ["הרגתן", "הִרְגַּעְתֶּן"], ["הרגיעו", "הִרְגִּיעוּ"]],
      ...
      imperative: [["הגע", "הַרְגַּע"], ["הרגיעי", "הַרְגִּיעִי"], ["הרגיעו", "הַרְגִּיעוּ"]],
    },
    {
  ...
  return batch.map(({ present, past, future, gloss, ...config }) => createVerbEntry({
    ...config,
    availability: getStarterVerbAvailability(config.id),
    conjugation_mode: "curated",
    senses: [makeSense(gloss, null, false)],
    forms: makeForms(
