...
persistence.persistSessionState = persistence.persistSessionState || function persistSessionState() {
  ...
  runtime.storageApi.saveJson(runtime.constants.STORAGE_KEYS.session, {
    ...
    summary: {
      ...
      corrects: runtime.state.summary.corrects,
    },
    lesson: {
    ...
    wordMatch: {
      active: runtime.state.wordMatch.active,
      introActive: runtime.state.wordMatch.introActive,
      game: runtime.state.wordMatch.game,
      startMs: runtime.state.wordMatch.startMs,
      elapsedSeconds: runtime.state.wordMatch.elapsedSeconds,
      pairs: runtime.state.wordMatch.pairs,
      remainingPairs: runtime.state.wordMatch.remainingPairs,
      leftCards: runtime.state.wordMatch.leftCards,
      rightCards: runtime.state.wordMatch.rightCards,
      selectedLeftId: runtime.state.wordMatch.selectedLeftId,
      selectedRightId: runtime.state.wordMatch.selectedRightId,
      mismatchedCardIds: runtime.state.wordMatch.mismatchedCardIds,
      matchedCardIds: runtime.state.wordMatch.matchedCardIds,
      matchedPairIds: runtime.state.wordMatch.matchedPairIds,
      isResolving: runtime.state.wordMatch.isResolving,
      nextCardId: runtime.state.wordMatch.nextCardId,
      matchedCount: runtime.state.wordMatch.matchedCount,
      totalPairs: runtime.state.wordMatch.totalPairs,
      combo: runtime.state.wordMatch.combo,
      bestCombo: runtime.state.wordMatch.bestCombo,
      mismatchCount: runtime.state.wordMatch.mismatchCount,
      sessionMistakeIds: runtime.state.wordMatch.sessionMistakeIds,
    },
    advConj: {
      active: runtime.state.advConj.active,
      introActive: runtime.state.advConj.introActive,
      currentRound: runtime.state.advConj.currentRound,
      startMs: runtime.state.advConj.startMs,
      elapsedSeconds: runtime.state.advConj.elapsedSeconds,
      questionQueue: runtime.state.advConj.questionQueue,
      currentQuestion: runtime.state.advConj.currentQuestion,
      wrongAnswers: runtime.state.advConj.wrongAnswers,
      sessionMistakeIds: runtime.state.advConj.sessionMistakeIds,
      sessionMistakes: runtime.state.advConj.sessionMistakes,
      inReview: runtime.state.advConj.inReview,
      reviewQueue: runtime.state.advConj.reviewQueue,
      secondChanceCurrent: runtime.state.advConj.secondChanceCurrent,
      secondChanceTotal: runtime.state.advConj.secondChanceTotal,
    },
    prepositions: {
      active: runtime.state.prepositions.active,
      introActive: runtime.state.prepositions.introActive,
      currentRound: runtime.state.prepositions.currentRound,
      startMs: runtime.state.prepositions.startMs,
      elapsedSeconds: runtime.state.prepositions.elapsedSeconds,
      questionQueue: runtime.state.prepositions.questionQueue,
      currentQuestion: runtime.state.prepositions.currentQuestion,
      wrongAnswers: runtime.state.prepositions.wrongAnswers,
      sessionMistakes: runtime.state.prepositions.sessionMistakes,
      inReview: runtime.state.prepositions.inReview,
      reviewQueue: runtime.state.prepositions.reviewQueue,
      secondChanceCurrent: runtime.state.prepositions.secondChanceCurrent,
      secondChanceTotal: runtime.state.prepositions.secondChanceTotal,
    },
    binyanBoard: {
      active: runtime.state.binyanBoard.active,
      introActive: runtime.state.binyanBoard.introActive,
      deck: runtime.state.binyanBoard.deck,
      distractorPool: runtime.state.binyanBoard.distractorPool,
      totalRoots: runtime.state.binyanBoard.totalRoots,
      clearedCount: runtime.state.binyanBoard.clearedCount,
      activeRootId: runtime.state.binyanBoard.activeRootId,
      roundForms: runtime.state.binyanBoard.roundForms,
      roundIndex: runtime.state.binyanBoard.roundIndex,
      currentQuestion: runtime.state.binyanBoard.currentQuestion,
      correctCount: runtime.state.binyanBoard.correctCount,
      wrongAnswers: runtime.state.binyanBoard.wrongAnswers,
      sessionMistakeIds: runtime.state.binyanBoard.sessionMistakeIds,
      inReview: runtime.state.binyanBoard.inReview,
      reviewQueue: runtime.state.binyanBoard.reviewQueue,
      secondChanceCurrent: runtime.state.binyanBoard.secondChanceCurrent,
      secondChanceTotal: runtime.state.binyanBoard.secondChanceTotal,
      startMs: runtime.state.binyanBoard.startMs,
      elapsedSeconds: runtime.state.binyanBoard.elapsedSeconds,
    },
    handwriting: {
      active: runtime.state.handwriting.active,
      introActive: runtime.state.handwriting.introActive,
      startMs: runtime.state.handwriting.startMs,
      elapsedSeconds: runtime.state.handwriting.elapsedSeconds,
      rounds: runtime.state.handwriting.rounds,
      roundIndex: runtime.state.handwriting.roundIndex,
      totalRounds: runtime.state.handwriting.totalRounds,
      cellIndex: runtime.state.handwriting.cellIndex,
      currentStrokes: runtime.state.handwriting.currentStrokes,
      attemptsThisCell: runtime.state.handwriting.attemptsThisCell,
      cellRecorded: runtime.state.handwriting.cellRecorded,
      lastTone: runtime.state.handwriting.lastTone,
      correctCount: runtime.state.handwriting.correctCount,
      mismatchCount: runtime.state.handwriting.mismatchCount,
      sessionMistakeIds: runtime.state.handwriting.sessionMistakeIds,
      isResolving: runtime.state.handwriting.isResolving,
    },
  });
};
