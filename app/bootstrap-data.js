...
bootstrapData.I18N = bootstrapData.I18N || {
  en: {
    ...
    session: {
      eyebrow: "Session",
      mixedTitle: "Vocabulary",
      secondChanceTitle: "Vocabulary Review",
      sentenceBankTitle: "Sentences",
      sentenceBankSecondChanceTitle: "Sentences Review",
      shemaTitle: "Shema",
      shemaSecondChanceTitle: "Shema Review",
      advConjSecondChanceTitle: "Conjugation+ Review",
      prepositionsSecondChanceTitle: "Prepositions Review",
      binyanSecondChanceTitle: "Binyanim Review",
    ...
    prompt: {
      lesson: "Lesson",
      start: 'Press "Start Vocabulary" to begin.',
      ...
      masteredOnlyTitle: "Vocabulary pool is empty",
      masteredOnlyBody: "All words are currently mastered for vocabulary. Reset progress in Settings to restore them.",
    ...
    feedback: {
      ...
      wrongResult: "Not quite",
      englishSentenceLabel: "English sentence",
      hebrewSentenceLabel: "Hebrew sentence",
      heardLabel: "You heard",
      meaningLabel: "Meaning",
      abbreviationLabel: "Abbreviation",
      expansionLabel: "Full Hebrew",
      tipLabel: "Tip",
      correctWordLabel: "Correct word",
      chosenWordLabel: "Chosen word",
      ...
      startAnother: 'Press "Start Vocabulary" to run another round.',
    ...
    summary: {
      ...
      lessonTitle: "Vocabulary Complete",
      ...
      matchNote: "Verbs: {verbs} | Best combo: {combo}",
      abbreviationNote: "Rounds: {rounds}",
      wordMatchNote: "Matched: {matched} | Best combo: {combo}",
      thumbsText: "Great work",
    },
    review: {
      trackingNote: "IvritElite tracks your performance to personalize practice and speed up your progress.",
      ...
      tabTrouble: "Trouble Spots",
      tabCharacters: "Characters",
      charactersTitle: "Your characters",
      tabWordBank: "Word Bank",
      statDue: "Due for review",
      statMastered: "Mastered",
      statSentences: "Sentences practiced",
      statLetters: "Letters learned",
      worstSentences: "Toughest Sentences",
      hardestVerbs: "Hardest Verbs",
      weakestLetters: "Weakest Letters",
      noTroubleData: "Not enough plays yet.",
      direction_he2en: "Hebrew → English",
      direction_en2he: "English → Hebrew",
      direction_listen: "Listening",
      letterBox: "Box {box}",
    },
    wordBank: {
      ...
      unmaster: "Restore to practice",
      count: "{shown} of {total} words",
    },
    settings: {
      title: "Settings",
      ...
      theme: "Theme",
      font: "Font",
      fontDescription: "Switch between Heebo and Frank Ruhl Libre. Each preview shows the Hebrew letter ayin.",
    ...
    pool: {
      summary: "Vocabulary pool: {pool} words with nikud ({total} in lexicon).",
  ...
  he: {
    ...
    session: {
      ...
      advConjSecondChanceTitle: "חזרה על נטיות+",
      prepositionsSecondChanceTitle: "חזרה על מילות יחס",
      binyanSecondChanceTitle: "חזרה על בניינים",
      ...
      score: "ציון: {score}",
      combo: "קומבו x{count}",
      start: "התחל אוצר מילים",
      restart: "התחל אוצר מילים מחדש",
    ...
    prompt: {
      lesson: "שיעור",
      start: 'לחץ על "התחל אוצר מילים" כדי להתחיל.',
      ...
      masteredOnlyTitle: "מאגר אוצר המילים ריק",
      masteredOnlyBody: "כל המילים כרגע נשלטו. אפס את ההתקדמות בהגדרות כדי להחזיר אותן.",
    ...
    feedback: {
      correctResult: "נכון",
      wrongResult: "לא בדיוק",
      englishSentenceLabel: "המשפט באנגלית",
      hebrewSentenceLabel: "המשפט בעברית",
      heardLabel: "שמעת",
      meaningLabel: "משמעות",
      abbreviationLabel: "קיצור",
      expansionLabel: "הניסוח המלא",
      tipLabel: "טיפ",
      correctWordLabel: "המילה הנכונה",
      chosenWordLabel: "המילה שנבחרה",
      ...
      startAnother: 'לחץ על "התחל אוצר מילים" כדי להתחיל עוד סבב.',
    ...
    summary: {
      ...
      matchNote: "פעלים: {verbs} | קומבו שיא: {combo}",
      abbreviationNote: "סבבים: {rounds}",
      wordMatchNote: "הותאמו: {matched} | קומבו שיא: {combo}",
      thumbsText: "כל הכבוד",
    },
    review: {
      trackingNote: "IvritElite עוקב אחר הביצועים שלך כדי להתאים את התרגול ולזרז את ההתקדמות.",
      ...
      tabTrouble: "נקודות תורפה",
      tabCharacters: "דמויות",
      charactersTitle: "הדמויות שלך",
      tabWordBank: "בנק מילים",
      statDue: "ממתינות לחזרה",
      statMastered: "מילים שנשלטו",
      statSentences: "משפטים שתורגלו",
      statLetters: "אותיות שנלמדו",
      worstSentences: "המשפטים הקשים ביותר",
      hardestVerbs: "הפעלים הקשים ביותר",
      weakestLetters: "האותיות החלשות ביותר",
      noTroubleData: "אין עדיין מספיק נתונים.",
      direction_he2en: "עברית ← אנגלית",
      direction_en2he: "אנגלית ← עברית",
      direction_listen: "האזנה",
      letterBox: "קופסה {box}",
    },
    wordBank: {
      searchPlaceholder: "חיפוש מילים…",
      filterAll: "הכל",
      empty: "אין מילים תואמות.",
      due: "לחזרה",
      newWord: "חדש",
      level: "רמה {level}",
      master: "סמן כמילה שנשלטה",
      unmaster: "החזר לתרגול",
      count: "{shown} מתוך {total} מילים",
    },
    settings: {
      title: "הגדרות",
      ...
      theme: "ערכת נושא",
      font: "גופן",
      fontDescription: "החלפה בין Heebo לבין Frank Ruhl Libre. כל תצוגה מקדימה מציגה את האות עי״ן.",
    ...
    pool: {
      summary: "מאגר אוצר המילים: {pool} מילים עם ניקוד ({total} בלקסיקון).",
    ...
    domain: {
      ...
      professional: "מקצועי",
      religion_magic: "דת ומיסטיקה",
      arts_culture: "אמנות ותרבות",
...
bootstrapData.PERFORMANCE_DOMAINS = bootstrapData.PERFORMANCE_DOMAINS || [
  ...
  // FALLBACK_DOMAIN_ID is derived from the last entry, so "formal" stays last.
  {
    id: "formal",
    emoji: "📚",
