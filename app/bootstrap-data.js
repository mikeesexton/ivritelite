...
bootstrapData.I18N = bootstrapData.I18N || {
  en: {
    ...
    binyan: {
      ...
      teaching: {
        ...
        hollowFactitiveActive: "This hollow root uses a special factitive active pattern here.",
        hollowFactitivePassive: "This hollow root uses a special factitive passive pattern here.",
    ...
    feedback: {
      ...
      sentenceBankGameTip: "Game tip: {detail}",
      ...
      advConjMeaningDetail: 'Colloquial meaning: "{meaning}".',
  ...
  he: {
    ...
    feedback: {
      ...
      sentenceBankGameTip: "טיפ למשחק: {detail}",
      ...
      advConjMeaningDetail: 'המשמעות המדוברת היא "{meaning}".',
