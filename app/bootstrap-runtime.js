...
bootstrapRuntime.createElementRegistry = bootstrapRuntime.createElementRegistry || function createElementRegistry(document) {
  return {
    ...
    shellGameplayBeat: document.querySelector("#shellGameplayBeat"),
    shellGameplayBeatStat: document.querySelector("#shellGameplayBeatStat"),
    shellGameplayBeatDivider: document.querySelector("#shellGameplayBeatDivider"),
    ...
    characterScene: document.querySelector("#characterScene"),
    characterSceneContent: document.querySelector("#characterSceneContent"),
    characterMissionHub: document.querySelector("#characterMissionHub"),
    characterCompanion: document.querySelector("#characterCompanion"),
    characterCompanionBubble: document.querySelector("#characterCompanionBubble"),
    characterCompanionSprite: document.querySelector("#characterCompanionSprite"),
    characterVisibilityToggle: document.querySelector("#characterVisibilityToggle"),
    characterQuitMission: document.querySelector("#characterQuitMission"),
    characterGenderToggle: document.querySelector("#characterGenderToggle"),
    characterGenderLabel: document.querySelector("#characterGenderLabel"),
    characterLensLabel: document.querySelector("#characterLensLabel"),
    characterLensOptions: document.querySelector("#characterLensOptions"),
    characterLensNote: document.querySelector("#characterLensNote"),
    reviewCharactersPanel: document.querySelector("#reviewCharactersPanel"),
    reviewCharacterBonds: document.querySelector("#reviewCharacterBonds"),
    reviewCharacterLensNote: document.querySelector("#reviewCharacterLensNote"),
...
bootstrapRuntime.createInitialState = bootstrapRuntime.createInitialState || function createInitialState(options) {
  ...
  return {
    ...
    reviewTab: ["characters", "overview", "trouble"].includes(restoredUi.reviewTab) ? restoredUi.reviewTab : "characters",
    mode: "home",
