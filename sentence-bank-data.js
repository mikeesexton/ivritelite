...
const SENTENCE_EXPANSION_ROUND2 = [
  ...
  buildExpandedSentence({
    ...
    hebrewDistractorPairs: [["היציאה", "הַיְּצִיאָה"], ["לחניון", "לַחֲנָיוֹן"], ["נמצא", "נִמְצָא"], ["הראשון", "הָרִאשׁוֹן"], ["למעלה", "לְמַעְלָה"]],
...
const SENTENCE_EXPANSION_ROUND3 = [
  ...
  buildExpandedSentence({
    ...
    hebrew: "כולם מדברים על הסרטון שהפך ויראלי.", hebrewNiqqud: "כֻּלָּם מְדַבְּרִים עַל הַסִּרְטוֹן שֶׁהָפַךְ וִירָאלִי.",
    english: "Everyone is talking about the video that went viral.",
    hebrewTokenPairs: [["כולם", "כֻּלָּם"], ["מדברים", "מְדַבְּרִים"], ["על", "עַל"], ["הסרטון", "הַסִּרְטוֹן"], ["שהפך", "שֶׁהָפַךְ"], ["ויראלי", "וִירָאלִי"]],
...
const SENTENCE_EXPANSION_ROUND4 = [
  ...
  buildExpandedSentence({
    ...
    hebrewDistractorPairs: [["הוא", "הוּא"], ["שלח", "שָׁלַח"], ["הודעת טקסט", "הוֹדָעַת טֶקְסְט"], ["שניות", "שְׁנִיּוֹת"], ["עונה", "עוֹנֶה"]],
  ...
  buildExpandedSentence({
    ...
    english: "Come on, let's go grab hummus in Jaffa before it runs out.",
    hebrewTokenPairs: [["בואי", "בּוֹאִי"], ["נלך", "נֵלֵךְ"], ["לנגב", "לְנַגֵּב"], ["חומוס", "חֻמּוּס"], ["ביפו", "בְּיָפוֹ"], ["לפני", "לִפְנֵי"], ["שייגמר", "שֶׁיִּגָּמֵר"]],
    englishTokens: ["Come on", "let's go", "grab", "hummus", "in Jaffa", "before it", "runs out"],
...
const INBAL_SENTENCES = [
  ...
  buildReviewedSentence({
    ...
    hebrewNiqqud: "בַּבְּרִית הַמִּילָה כּוּלָּם בָּכוּ חוּץ מֵהַתִּינוֹק.",
    english: "At the circumcision everyone cried but not the baby.",
    hebrewTokenPairs: [["בברית המילה", "בַּבְּרִית הַמִּילָה"], ["כולם", "כּוּלָּם"], ["בכו", "בָּכוּ"], ["חוץ מהתינוק", "חוּץ מֵהַתִּינוֹק"]],
...
const INAT_SENTENCES = [
  ...
  buildReviewedSentence({
    ...
    hebrewNiqqud: "סָאטִירָה תּוֹקֶפֶת כֹּחַ פּוֹלִיטִי בְּאֶמְצָעוּת הוּמוֹר.",
    english: "Satire attacks political power through humor.",
    hebrewTokenPairs: [["סאטירה", "סָאטִירָה"], ["תוקפת", "תּוֹקֶפֶת"], ["כוח", "כֹּחַ"], ["פוליטי", "פּוֹלִיטִי"], ["באמצעות", "בְּאֶמְצָעוּת"], ["הומור", "הוּמוֹר"]],
...
const IDAN_SENTENCES = [
  ...
  buildReviewedSentence({
    ...
    hebrewDistractorPairs: [["תצאו", "תֵּצְאוּ"], ["בחדר המדרגות", "בַּחֲדַר הַמַּדְרֵגוֹת"], ["לפני האזעקה", "לִפְנֵי הָאַזְעָקָה"], ["בזמן ההפוגה", "בִּזְמַן הַהֲפוּגָה"]],
    englishDistractors: ["Go out", "in the stairwell", "before the siren", "during the lull"],
  ...
  buildReviewedSentence({
    ...
    hebrewDistractorPairs: [["תשאירו", "תַּשְׁאִירוּ"], ["ארון סגור", "אָרוֹן סָגוּר"], ["בלי אוכל", "בְּלִי אוֹכֶל"], ["ובגדים", "וּבְגָדִים"]],
  ...
  buildReviewedSentence({
    ...
    hebrewDistractorPairs: [["שלחתי", "שָׁלַחְתִּי"], ["פטור רפואי", "פְּטוֹר רְפוּאִי"], ["בלילה", "בַּלַּיְלָה"], ["בערב", "בָּעֶרֶב"]],
    englishDistractors: ["I sent", "a medical exemption", "at night", "in the evening"],
  ...
  buildReviewedSentence({
    ...
    hebrewDistractorPairs: [["היא", "הִיא"], ["בשירות סדיר", "בְּשֵׁירוּת סָדִיר"], ["בשנה", "בַּשָּׁנָה"], ["בבית", "בַּבַּיִת"]],
    englishDistractors: ["She", "is in regular service", "in the year", "at home"],
  ...
  buildReviewedSentence({
    ...
    wordOrderDecision: "fixed",
    hebrew: "הכוח נשאר בגזרה עד יום שישי.", hebrewNiqqud: "הַכֹּחַ נִשְׁאַר בַּגִּזְרָה עַד יוֹם שִׁישִׁי.",
    english: "The force stayed in the sector until Friday.",
    hebrewTokenPairs: [["הכוח", "הַכֹּחַ"], ["נשאר", "נִשְׁאַר"], ["בגזרה", "בַּגִּזְרָה"], ["עד יום שישי", "עַד יוֹם שִׁישִׁי"]],
  ...
  buildReviewedSentence({
    ...
    wordOrderDecision: "fixed",
    hebrew: "הוא דיווח למפקד על מה שראה.", hebrewNiqqud: "הוּא דִּיווּחַ לַמְּפַקֵּד עַל מָה שֶׁרָאָה.",
    english: "He reported to the commander what he saw.",
    hebrewTokenPairs: [["הוא", "הוּא"], ["דיווח", "דִּיווּחַ"], ["למפקד", "לַמְּפַקֵּד"], ["על מה שראה", "עַל מָה שֶׁרָאָה"]],
  ...
  buildReviewedSentence({
    ...
    hebrewDistractorPairs: [["המבצע", "הַמִּבְצָע"], ["הסתיים", "הִסְתַּיֵּים"], ["אחרי שקיעת השמש", "אַחֲרֵי שְׁקִיעַת הַשֶּׁמֶשׁ"], ["בצהריים", "בַּצָּהֳרַיִים"]],
    englishDistractors: ["The operation", "ended", "after sunset", "at noon"],
    hebrewOrderAlternates: [
  ...
  buildReviewedSentence({
    ...
    hebrewDistractorPairs: [["רמת הכוננות", "רָמַת הַכּוֹנְנוּת"], ["נשארה", "נִשְׁאֲרָה"], ["לפני התדריך", "לִפְנֵי הַתַּדְרִיךְ"], ["אחרי התרגיל", "אַחֲרֵי הַתַּרְגִּיל"]],
    englishDistractors: ["The alert level", "stayed", "before the briefing", "after the exercise"],
  ...
  buildReviewedSentence({
    id: "idan_25", emoji: "🏠", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "השכנים הצטרפו אלינו במרחב המוגן.", hebrewNiqqud: "הַשְּׁכֵנִים הִצְטָרְפוּ אֵלֵינוּ בַּמֶּרְחָב הַמּוּגָן.",
    english: "The neighbours joined us in the protected space.",
    hebrewTokenPairs: [["השכנים", "הַשְּׁכֵנִים"], ["הצטרפו", "הִצְטָרְפוּ"], ["אלינו", "אֵלֵינוּ"], ["במרחב המוגן", "בַּמֶּרְחָב הַמּוּגָן"]],
    englishTokens: ["The neighbours", "joined", "us", "in the protected space"],
    hebrewDistractorPairs: [["הדיירים", "הַדַּיָּירִים"], ["חיכו", "חִיכּוּ"], ["לנו", "לָנוּ"], ["בחדר המדרגות", "בַּחֲדַר הַמַּדְרֵגוֹת"]],
    englishDistractors: ["The tenants", "waited", "for us", "in the stairwell"],
    notes: "Neighbours in an older building often share a single מרחב מוגן."
  }),
  buildReviewedSentence({
    id: "idan_26", emoji: "👵", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "צריך לעזור לשכנה לרדת.", hebrewNiqqud: "צָרִיךְ לַעֲזוֹר לַשְּׁכֵנָה לָרֶדֶת.",
    english: "We need to help the neighbour downstairs.",
    hebrewTokenPairs: [["צריך", "צָרִיךְ"], ["לעזור", "לַעֲזוֹר"], ["לשכנה", "לַשְּׁכֵנָה"], ["לרדת", "לָרֶדֶת"]],
    englishTokens: ["We need", "to help", "the neighbour", "downstairs"],
    hebrewDistractorPairs: [["אסור", "אָסוּר"], ["להפריע", "לְהַפְרִיעַ"], ["לשוטר", "לַשּׁוֹטֵר"], ["למעלה", "לְמַעְלָה"]],
    englishDistractors: ["It's forbidden", "to disturb", "the officer", "upstairs"],
    notes: "Home Front Command asks residents to check on elderly neighbours before an alert."
  }),
  buildReviewedSentence({
    id: "idan_27", emoji: "🐕", category: "everyday", difficulty: 1,
    wordOrderDecision: "fixed",
    hebrew: "הכלב נכנס איתנו למרחב המוגן.", hebrewNiqqud: "הַכֶּלֶב נִכְנַס אִיתָּנוּ לַמֶּרְחָב הַמּוּגָן.",
    english: "The dog entered the protected space with us.",
    hebrewTokenPairs: [["הכלב", "הַכֶּלֶב"], ["נכנס", "נִכְנַס"], ["איתנו", "אִיתָּנוּ"], ["למרחב המוגן", "לַמֶּרְחָב הַמּוּגָן"]],
    englishTokens: ["The dog", "entered", "the protected space", "with us"],
    hebrewDistractorPairs: [["החתול", "הֶחָתוּל"], ["נשאר", "נִשְׁאַר"], ["בחצר", "בֶּחָצֵר"], ["לבד", "לְבַד"]],
    englishDistractors: ["The cat", "stayed", "in the yard", "alone"],
    notes: "Pets are allowed in a מרחב מוגן; nothing in the guidance excludes them."
  }),
  buildReviewedSentence({
    id: "idan_28", emoji: "🪜", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "בזמן אזעקה לא משתמשים במעלית.", hebrewNiqqud: "בִּזְמַן אַזְעָקָה לֹא מִשְׁתַּמְּשִׁים בַּמַּעֲלִית.",
    english: "During a siren we do not use the elevator.",
    hebrewTokenPairs: [["בזמן אזעקה", "בִּזְמַן אַזְעָקָה"], ["לא", "לֹא"], ["משתמשים", "מִשְׁתַּמְּשִׁים"], ["במעלית", "בַּמַּעֲלִית"]],
    englishTokens: ["During a siren", "we do not", "use", "the elevator"],
    hebrewDistractorPairs: [["אחרי ההודעה", "אַחֲרֵי הַהוֹדָעָה"], ["כן", "כֵּן"], ["עולים", "עוֹלִים"], ["במדרגות", "בַּמַּדְרֵגוֹת"]],
    englishDistractors: ["After the message", "yes", "go up", "the stairs"],
    notes: "An elevator can stop in a power cut, which is why the stairs are the rule."
  }),
  buildReviewedSentence({
    id: "idan_29", emoji: "💥", category: "everyday", difficulty: 3,
    wordOrderDecision: "fixed",
    hebrew: "רסיסים נפלו ברחוב אחרי היירוט.", hebrewNiqqud: "רְסִיסִים נָפְלוּ בָּרְחוֹב אַחֲרֵי הַיִּירוּט.",
    english: "Fragments fell in the street after the interception.",
    hebrewTokenPairs: [["רסיסים", "רְסִיסִים"], ["נפלו", "נָפְלוּ"], ["ברחוב", "בָּרְחוֹב"], ["אחרי היירוט", "אַחֲרֵי הַיִּירוּט"]],
    englishTokens: ["Fragments", "fell", "in the street", "after the interception"],
    hebrewDistractorPairs: [["עשן", "עָשָׁן"], ["עלה", "עָלָה"], ["מהגג", "מֵהַגַּג"], ["לפני האזעקה", "לִפְנֵי הָאַזְעָקָה"]],
    englishDistractors: ["Smoke", "rose", "from the roof", "before the siren"],
    notes: "Falling interceptor fragments are the reason for the ten-minute wait indoors."
  }),
  buildReviewedSentence({
    id: "idan_30", emoji: "⚠️", category: "everyday", difficulty: 1,
    wordOrderDecision: "fixed",
    hebrew: "אסור לגעת ברסיסים ברחוב.", hebrewNiqqud: "אָסוּר לָגַעַת בָּרְסִיסִים בָּרְחוֹב.",
    english: "It's forbidden to touch fragments in the street.",
    hebrewTokenPairs: [["אסור", "אָסוּר"], ["לגעת", "לָגַעַת"], ["ברסיסים", "בָּרְסִיסִים"], ["ברחוב", "בָּרְחוֹב"]],
    englishTokens: ["It's forbidden", "to touch", "fragments", "in the street"],
    hebrewDistractorPairs: [["מותר", "מוּתָּר"], ["לאסוף", "לֶאֱסוֹף"], ["אבנים", "אֲבָנִים"], ["בחצר", "בֶּחָצֵר"]],
    englishDistractors: ["It's allowed", "to collect", "stones", "in the yard"],
    notes: "Fragments can still be hot or unstable, so the police collect them."
  }),
  buildReviewedSentence({
    id: "idan_31", emoji: "🏨", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "המשפחה פונתה למלון בעיר אחרת.", hebrewNiqqud: "הַמִּשְׁפָּחָה פּוּנְּתָה לְמָלוֹן בְּעִיר אַחֶרֶת.",
    english: "The family was evacuated to a hotel in another city.",
    hebrewTokenPairs: [["המשפחה", "הַמִּשְׁפָּחָה"], ["פונתה", "פּוּנְּתָה"], ["למלון", "לְמָלוֹן"], ["בעיר אחרת", "בְּעִיר אַחֶרֶת"]],
    englishTokens: ["The family", "was evacuated", "to a hotel", "in another city"],
    hebrewDistractorPairs: [["הזוג", "הַזּוּג"], ["חזר", "חָזַר"], ["לדירה", "לַדִּירָה"], ["באותו רחוב", "בְּאוֹתוֹ רְחוֹב"]],
    englishDistractors: ["The couple", "returned", "to the apartment", "on our street"],
    notes: "פינוי is the official word for an evacuation, organized or self-arranged."
  }),
  buildReviewedSentence({
    id: "idan_32", emoji: "🛏️", category: "everyday", difficulty: 3,
    wordOrderDecision: "fixed",
    hebrew: "המשפחה קיבלה מגורים זמניים לחודש.", hebrewNiqqud: "הַמִּשְׁפָּחָה קִיבְּלָה מְגוּרִים זְמַנִּיִּים לְחוֹדֶשׁ.",
    english: "The family received temporary housing for a month.",
    hebrewTokenPairs: [["המשפחה", "הַמִּשְׁפָּחָה"], ["קיבלה", "קִיבְּלָה"], ["מגורים זמניים", "מְגוּרִים זְמַנִּיִּים"], ["לחודש", "לְחוֹדֶשׁ"]],
    englishTokens: ["The family", "received", "temporary housing", "for a month"],
    hebrewDistractorPairs: [["הזוג", "הַזּוּג"], ["ביקש", "בִּיקֵּשׁ"], ["דירה", "דִּירָה"], ["לשבוע", "לְשָׁבוּעַ"]],
    englishDistractors: ["The couple", "requested", "an apartment", "for a week"],
    notes: "מגורים זמניים covers hotels, dormitories, and rented flats for evacuees."
  }),
  buildReviewedSentence({
    id: "idan_33", emoji: "🩹", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "צריך ללחוץ חזק על הפצע.", hebrewNiqqud: "צָרִיךְ לִלְחוֹץ חָזָק עַל הַפֶּצַע.",
    english: "We need to press hard on the wound.",
    hebrewTokenPairs: [["צריך", "צָרִיךְ"], ["ללחוץ", "לִלְחוֹץ"], ["חזק", "חָזָק"], ["על הפצע", "עַל הַפֶּצַע"]],
    englishTokens: ["We need", "to press", "hard", "on the wound"],
    hebrewDistractorPairs: [["אסור", "אָסוּר"], ["לשטוף", "לִשְׁטוֹף"], ["מהר", "מַהֵר"], ["את הידיים", "אֶת הַיָּדַיִים"]],
    englishDistractors: ["It's forbidden", "to rinse", "quickly", "the hands"],
    notes: "Direct pressure is the first step against דימום, before any bandage."
  }),
  buildReviewedSentence({
    id: "idan_34", emoji: "🔥", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "שוטפים כווייה במים.", hebrewNiqqud: "שׁוֹטְפִים כְּוִויָּיה בְּמַיִם.",
    english: "We rinse a burn with water.",
    hebrewTokenPairs: [["שוטפים", "שׁוֹטְפִים"], ["כווייה", "כְּוִויָּיה"], ["במים", "בְּמַיִם"]],
    englishTokens: ["We rinse", "a burn", "with water"],
    hebrewDistractorPairs: [["מכסים", "מְכַסִּים"], ["חבלה", "חַבָּלָה"], ["בבד יבש", "בְּבַד יָבֵשׁ"], ["בקרח", "בְּקֶרַח"]],
    englishDistractors: ["We cover", "an injury", "with a cloth", "with ice"],
    notes: "Cold running water, not ice, is the standard first response to a כווייה."
  }),
  buildReviewedSentence({
    id: "idan_35", emoji: "🚨", category: "everyday", difficulty: 1,
    wordOrderDecision: "fixed",
    hebrew: "מישהו נחנק, תקראו לעזרה.", hebrewNiqqud: "מִישֶׁהוּ נֶחְנָק, תִּקְרְאוּ לְעֶזְרָה.",
    english: "Someone is choking, call for help.",
    hebrewTokenPairs: [["מישהו", "מִישֶׁהוּ"], ["נחנק", "נֶחְנָק"], ["תקראו", "תִּקְרְאוּ"], ["לעזרה", "לְעֶזְרָה"]],
    englishTokens: ["Someone", "is choking", "call", "for help"],
    hebrewDistractorPairs: [["הילד", "הַיֶּלֶד"], ["נרדם", "נִרְדַּם"], ["תחכו", "תְּחַכּוּ"], ["בשקט", "בְּשֶׁקֶט"]],
    englishDistractors: ["The child", "slept", "wait", "quietly"],
    notes: "חנק is the noun; נחנק is the verb a bystander would actually shout."
  }),
  buildReviewedSentence({
    id: "idan_36", emoji: "❤️", category: "everyday", difficulty: 3,
    wordOrderDecision: "fixed",
    hebrew: "עברתי קורס החייאה.", hebrewNiqqud: "עָבַרְתִּי קוּרְס הַחְיָיאָה.",
    english: "I took a course in resuscitation.",
    hebrewTokenPairs: [["עברתי", "עָבַרְתִּי"], ["קורס", "קוּרְס"], ["החייאה", "הַחְיָיאָה"]],
    englishTokens: ["I took", "a course", "in resuscitation"],
    hebrewDistractorPairs: [["ביטלתי", "בִּיטַּלְתִּי"], ["תרגיל פינוי", "תַּרְגִּיל פִּינּוּי"], ["בבית", "בַּבַּיִת"], ["בבוקר", "בַּבֹּקֶר"]],
    englishDistractors: ["I cancelled", "a drill", "at home", "in the morning"],
    notes: "החייאה is the Hebrew for CPR; many workplaces run a short course."
  }),
  buildReviewedSentence({
    id: "idan_37", emoji: "🧯", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "היום היה תרגיל שריפה במשרד.", hebrewNiqqud: "הַיּוֹם הָיָה תַּרְגִּיל שְׂרֵיפָה בַּמִּשְׂרָד.",
    english: "Today there was a fire drill at the office.",
    hebrewTokenPairs: [["היום", "הַיּוֹם"], ["היה", "הָיָה"], ["תרגיל שריפה", "תַּרְגִּיל שְׂרֵיפָה"], ["במשרד", "בַּמִּשְׂרָד"]],
    englishTokens: ["Today", "there was", "a fire drill", "at the office"],
    hebrewDistractorPairs: [["מחר", "מָחָר"], ["יהיה", "יִהְיֶה"], ["תרגיל התגוננות", "תַּרְגִּיל הִתְגּוֹנְנוּת"], ["בבניין", "בַּבִּנְיָן"]],
    englishDistractors: ["Tomorrow", "there will be", "a defense drill", "in the building"],
    notes: "תרגיל שריפה is a workplace fire drill; תרגיל התגוננות is the home-front one."
  }),
  buildReviewedSentence({
    id: "idan_38", emoji: "💨", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "כשיש עשן זוחלים על הרצפה.", hebrewNiqqud: "כְּשֶׁיֵּשׁ עָשָׁן זוֹחֲלִים עַל הָרִצְפָּה.",
    english: "When there is smoke we crawl on the floor.",
    hebrewTokenPairs: [["כשיש עשן", "כְּשֶׁיֵּשׁ עָשָׁן"], ["זוחלים", "זוֹחֲלִים"], ["על הרצפה", "עַל הָרִצְפָּה"]],
    englishTokens: ["When there is smoke", "we crawl", "on the floor"],
    hebrewDistractorPairs: [["כשיש אזעקה", "כְּשֶׁיֵּשׁ אַזְעָקָה"], ["רצים", "רָצִים"], ["על הגג", "עַל הַגַּג"], ["במדרגות", "בַּמַּדְרֵגוֹת"]],
    englishDistractors: ["When there is a siren", "we run", "on the roof", "on the stairs"],
    notes: "Smoke rises, so the clean air is low; this is standard fire guidance."
  }),
  buildReviewedSentence({
    id: "idan_39", emoji: "🚪", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "יציאת החירום הייתה חסומה.", hebrewNiqqud: "יְצִיאַת הַחֵירוּם הָיְיתָה חֲסוּמָה.",
    english: "The emergency exit was blocked.",
    hebrewTokenPairs: [["יציאת החירום", "יְצִיאַת הַחֵירוּם"], ["הייתה", "הָיְיתָה"], ["חסומה", "חֲסוּמָה"]],
    englishTokens: ["The emergency exit", "was", "blocked"],
    hebrewDistractorPairs: [["דלת הממ״ד", "דֶּלֶת הַמַּמָּ״ד"], ["נשארה", "נִשְׁאֲרָה"], ["פתוחה", "פְּתוּחָה"], ["נעולה", "נְעוּלָה"]],
    englishDistractors: ["The door", "stayed", "open", "locked"],
    notes: "A blocked יציאת חירום is a reportable מפגע בטיחותי in any public building."
  }),
  buildReviewedSentence({
    id: "idan_40", emoji: "🚸", category: "everyday", difficulty: 1,
    wordOrderDecision: "fixed",
    hebrew: "חוצים את הכביש רק במעבר חצייה.", hebrewNiqqud: "חוֹצִים אֶת הַכְּבִישׁ רַק בְּמַעֲבַר חֲצִיָּיה.",
    english: "We cross the road only at a crosswalk.",
    hebrewTokenPairs: [["חוצים", "חוֹצִים"], ["את הכביש", "אֶת הַכְּבִישׁ"], ["רק", "רַק"], ["במעבר חצייה", "בְּמַעֲבַר חֲצִיָּיה"]],
    englishTokens: ["We cross", "the road", "only", "at a crosswalk"],
    hebrewDistractorPairs: [["עוברים", "עוֹבְרִים"], ["את הגשר", "אֶת הַגֶּשֶׁר"], ["תמיד", "תָּמִיד"], ["ברמזור אדום", "בְּרַמְזוֹר אָדוֹם"]],
    englishDistractors: ["We pass", "the bridge", "always", "on the sidewalk"],
    notes: "מעבר חצייה is the marked crossing; the phrase is fixed in road-safety notices."
  }),
  buildReviewedSentence({
    id: "idan_41", emoji: "👷", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "באתר בנייה חובה לחבוש קסדה.", hebrewNiqqud: "בְּאֲתַר בְּנִיָּיה חוֹבָה לַחְבּוֹשׁ קַסְדָּה.",
    english: "At a site it is required to wear a helmet.",
    hebrewTokenPairs: [["באתר בנייה", "בְּאֲתַר בְּנִיָּיה"], ["חובה", "חוֹבָה"], ["לחבוש", "לַחְבּוֹשׁ"], ["קסדה", "קַסְדָּה"]],
    englishTokens: ["At a site", "it is required", "to wear", "a helmet"],
    hebrewDistractorPairs: [["במפעל", "בַּמִּפְעָל"], ["אפשר", "אֶפְשָׁר"], ["להוריד", "לְהוֹרִיד"], ["כפפות", "כְּפָפוֹת"]],
    englishDistractors: ["At a factory", "it is possible", "to remove", "gloves"],
    notes: "לחבוש is the verb for a helmet or a bandage, not ללבוש."
  }),
  buildReviewedSentence({
    id: "idan_42", emoji: "🏊", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "שוחים רק במקום עם מציל.", hebrewNiqqud: "שׂוֹחִים רַק בְּמָקוֹם עִם מַצִּיל.",
    english: "We swim only in a place with a lifeguard.",
    hebrewTokenPairs: [["שוחים", "שׂוֹחִים"], ["רק", "רַק"], ["במקום", "בְּמָקוֹם"], ["עם מציל", "עִם מַצִּיל"]],
    englishTokens: ["We swim", "only", "in a place", "with a lifeguard"],
    hebrewDistractorPairs: [["רצים", "רָצִים"], ["תמיד", "תָּמִיד"], ["בחוף", "בַּחוֹף"], ["בלי חולצה", "בְּלִי חוּלְצָה"]],
    englishDistractors: ["We run", "always", "on the beach", "without a shirt"],
    notes: "מציל is the lifeguard; an unguarded beach is חוף לא מוכרז."
  }),
  buildReviewedSentence({
    id: "idan_43", emoji: "⚡", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "אסור לגעת בחשמל בידיים רטובות.", hebrewNiqqud: "אָסוּר לָגַעַת בַּחַשְׁמַל בְּיָדַיִים רְטוּבּוֹת.",
    english: "It's forbidden to touch electricity with wet hands.",
    hebrewTokenPairs: [["אסור", "אָסוּר"], ["לגעת", "לָגַעַת"], ["בחשמל", "בַּחַשְׁמַל"], ["בידיים רטובות", "בְּיָדַיִים רְטוּבּוֹת"]],
    englishTokens: ["It's forbidden", "to touch", "electricity", "with wet hands"],
    hebrewDistractorPairs: [["כדאי", "כְּדַאי"], ["לבדוק", "לִבְדּוֹק"], ["את המטען", "אֶת הַמַּטְעָן"], ["בבית חם", "בְּבַיִת חַם"]],
    englishDistractors: ["It's worth", "to check", "the charger", "at home"],
    notes: "A basic safety line; חשמל covers both the current and the utility."
  }),
  buildReviewedSentence({
    id: "idan_44", emoji: "📞", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "כשמתקשרים למוקד אומרים את הכתובת.", hebrewNiqqud: "כְּשֶׁמִּתְקַשְּׁרִים לַמּוֹקֵד אוֹמְרִים אֶת הַכְּתוֹבֶת.",
    english: "When calling the center we give the address.",
    hebrewTokenPairs: [["כשמתקשרים", "כְּשֶׁמִּתְקַשְּׁרִים"], ["למוקד", "לַמּוֹקֵד"], ["אומרים", "אוֹמְרִים"], ["את הכתובת", "אֶת הַכְּתוֹבֶת"]],
    englishTokens: ["When calling", "the center", "we give", "the address"],
    hebrewDistractorPairs: [["כששולחים", "כְּשֶׁשּׁוֹלְחִים"], ["למשטרה", "לַמִּשְׁטָרָה"], ["שוכחים", "שׁוֹכְחִים"], ["מספר טלפון", "מִסְפַּר טֶלֶפוֹן"]],
    englishDistractors: ["When sending", "to the police", "we forget", "a number"],
    notes: "The מוקדן asks for the address first; everything else follows from it."
  }),
  buildReviewedSentence({
    id: "idan_45", emoji: "🚓", category: "everyday", difficulty: 1,
    wordOrderDecision: "fixed",
    hebrew: "למשטרה מתקשרים למאה.", hebrewNiqqud: "לַמִּשְׁטָרָה מִתְקַשְּׁרִים לְמֵאָה.",
    english: "For the police we call one hundred.",
    hebrewTokenPairs: [["למשטרה", "לַמִּשְׁטָרָה"], ["מתקשרים", "מִתְקַשְּׁרִים"], ["למאה", "לְמֵאָה"]],
    englishTokens: ["For the police", "we call", "one hundred"],
    hebrewDistractorPairs: [["לכבאים", "לַכַּבָּאִים"], ["שולחים", "שׁוֹלְחִים"], ["למאה ושתיים", "לְמֵאָה וּשְׁתַּיִים"], ["לאמבולנס", "לְאַמְבּוּלַנְס"]],
    englishDistractors: ["For the firefighters", "we send", "another number", "for an ambulance"],
    notes: "100 is the police, 101 Magen David Adom, 102 the fire service."
  }),
  buildReviewedSentence({
    id: "idan_46", emoji: "💧", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "מחזיקים מים לשלושה ימים.", hebrewNiqqud: "מַחְזִיקִים מַיִם לִשְׁלוֹשָׁה יָמִים.",
    english: "We keep water for three days.",
    hebrewTokenPairs: [["מחזיקים", "מַחְזִיקִים"], ["מים", "מַיִם"], ["לשלושה", "לִשְׁלוֹשָׁה"], ["ימים", "יָמִים"]],
    englishTokens: ["We keep", "water", "for three", "days"],
    hebrewDistractorPairs: [["קונים", "קוֹנִים"], ["לחם", "לֶחֶם"], ["לשעה אחת", "לְשָׁעָה אַחַת"], ["במקלט", "בַּמִּקְלָט"]],
    englishDistractors: ["We buy", "bread", "for an hour", "in the shelter"],
    notes: "Three days of water per person is the standard Home Front Command figure."
  }),
  buildReviewedSentence({
    id: "idan_47", emoji: "🔋", category: "everyday", difficulty: 1,
    wordOrderDecision: "fixed",
    hebrew: "בתיק החירום יש סוללות ורדיו.", hebrewNiqqud: "בְּתִיק הַחֵירוּם יֵשׁ סוֹלְלוֹת וְרַדְיוֹ.",
    english: "In the emergency bag there are batteries and a radio.",
    hebrewTokenPairs: [["בתיק החירום", "בְּתִיק הַחֵירוּם"], ["יש", "יֵשׁ"], ["סוללות", "סוֹלְלוֹת"], ["ורדיו", "וְרַדְיוֹ"]],
    englishTokens: ["In the emergency bag", "there are", "batteries", "and a radio"],
    hebrewDistractorPairs: [["בארון", "בָּאָרוֹן"], ["אין", "אֵין"], ["נעליים", "נַעֲלַיִים"], ["ומחשב", "וּמַחְשֵׁב"]],
    englishDistractors: ["In the cupboard", "there are no", "shoes", "and a computer"],
    notes: "A battery radio matters because the phone network can fail."
  }),
  buildReviewedSentence({
    id: "idan_48", emoji: "📄", category: "everyday", difficulty: 3,
    wordOrderDecision: "fixed",
    hebrew: "שמים תעודות ותרופות בתיק אחד.", hebrewNiqqud: "שָׂמִים תְּעוּדוֹת וּתְרוּפוֹת בְּתִיק אֶחָד.",
    english: "We put documents and medicine in one bag.",
    hebrewTokenPairs: [["שמים", "שָׂמִים"], ["תעודות", "תְּעוּדוֹת"], ["ותרופות", "וּתְרוּפוֹת"], ["בתיק אחד", "בְּתִיק אֶחָד"]],
    englishTokens: ["We put", "documents", "and medicine", "in one bag"],
    hebrewDistractorPairs: [["מחפשים", "מְחַפְּשִׂים"], ["מפתחות", "מַפְתְּחוֹת"], ["וכספים", "וּכְסָפִים"], ["בשני ארונות", "בִּשְׁנֵי אֲרוֹנוֹת"]],
    englishDistractors: ["We look for", "keys", "and money", "in a cupboard"],
    notes: "Copies of תעודת זהות and prescriptions are on the official packing list."
  }),
  buildReviewedSentence({
    id: "idan_49", emoji: "🕯️", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "הפסקת החשמל נמשכה כל הלילה.", hebrewNiqqud: "הַפְסָקַת הַחַשְׁמַל נִמְשְׁכָה כָּל הַלַּיְלָה.",
    english: "The power outage lasted all night.",
    hebrewTokenPairs: [["הפסקת החשמל", "הַפְסָקַת הַחַשְׁמַל"], ["נמשכה", "נִמְשְׁכָה"], ["כל הלילה", "כָּל הַלַּיְלָה"]],
    englishTokens: ["The power outage", "lasted", "all night"],
    hebrewDistractorPairs: [["הפסקת המים", "הַפְסָקַת הַמַּיִם"], ["הסתיימה", "הִסְתַּיְּימָה"], ["בבוקר", "בַּבֹּקֶר"], ["מהר", "מַהֵר"]],
    englishDistractors: ["The water outage", "ended", "in the morning", "quickly"],
    notes: "הפסקת חשמל is the fixed compound; a brief one is called נפילת מתח."
  }),
  buildReviewedSentence({
    ...
    notes: "עירייה handles water and shelters; פיקוד העורף handles the alerts."
  }),
  buildReviewedSentence({
    id: "idan_51", emoji: "😰", category: "everyday", difficulty: 3,
    wordOrderDecision: "fixed",
    hebrew: "אחרי האזעקה הרגשתי חרדה.", hebrewNiqqud: "אַחֲרֵי הָאַזְעָקָה הִרְגַּשְׁתִּי חֲרָדָה.",
    english: "After the siren I felt anxiety.",
    hebrewTokenPairs: [["אחרי האזעקה", "אַחֲרֵי הָאַזְעָקָה"], ["הרגשתי", "הִרְגַּשְׁתִּי"], ["חרדה", "חֲרָדָה"]],
    englishTokens: ["After the siren", "I felt", "anxiety"],
    hebrewDistractorPairs: [["לפני ההודעה", "לִפְנֵי הַהוֹדָעָה"], ["שכחתי", "שָׁכַחְתִּי"], ["רגיעה", "רְגִיעָה"], ["חוסן", "חוֹסֶן"]],
    englishDistractors: ["Before the message", "I forgot", "calm", "resilience"],
    notes: "חרדה is clinical anxiety; פחד is ordinary fear, and the two are not swapped."
  }),
  buildReviewedSentence({
    id: "idan_52", emoji: "🧠", category: "everyday", difficulty: 3,
    wordOrderDecision: "fixed",
    hebrew: "מרכז החוסן עוזר למשפחות באזור.", hebrewNiqqud: "מֶרְכַּז הַחוֹסֶן עוֹזֵר לְמִשְׁפָּחוֹת בָּאֵזוֹר.",
    english: "The resilience center helps families in the area.",
    hebrewTokenPairs: [["מרכז החוסן", "מֶרְכַּז הַחוֹסֶן"], ["עוזר", "עוֹזֵר"], ["למשפחות", "לְמִשְׁפָּחוֹת"], ["באזור", "בָּאֵזוֹר"]],
    englishTokens: ["The resilience center", "helps", "families", "in the area"],
    hebrewDistractorPairs: [["קו התמיכה", "קַו הַתְּמִיכָה"], ["מפריע", "מַפְרִיעַ"], ["לשכנים", "לַשְּׁכֵנִים"], ["בעיר", "בָּעִיר"]],
    englishDistractors: ["The support line", "disturbs", "the neighbours", "in the city"],
    notes: "מרכז חוסן is a municipal service, distinct from a hospital clinic."
  }),
  buildReviewedSentence({
    id: "idan_53", emoji: "🧒", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "מדברים עם הילדים בשקט ובאמת.", hebrewNiqqud: "מְדַבְּרִים עִם הַיְלָדִים בְּשֶׁקֶט וּבֶאֱמֶת.",
    english: "We speak with the children calmly and honestly.",
    hebrewTokenPairs: [["מדברים", "מְדַבְּרִים"], ["עם הילדים", "עִם הַיְלָדִים"], ["בשקט", "בְּשֶׁקֶט"], ["ובאמת", "וּבֶאֱמֶת"]],
    englishTokens: ["We speak", "with the children", "calmly", "and honestly"],
    hebrewDistractorPairs: [["צועקים", "צוֹעֲקִים"], ["על השכנים", "עַל הַשְּׁכֵנִים"], ["בכעס", "בְּכַעַס"], ["ובלי סיבה", "וּבְלִי סִיבָּה"]],
    englishDistractors: ["We shout", "at the neighbours", "angrily", "and without reason"],
    notes: "Home Front Command guidance for parents: short, true answers, calm voice."
  }),
  buildReviewedSentence({
    id: "idan_54", emoji: "🛍️", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "בכניסה לקניון יש בידוק.", hebrewNiqqud: "בַּכְּנִיסָה לַקַּנְיוֹן יֵשׁ בִּידּוּק.",
    english: "At the entrance to the mall there is a security check.",
    hebrewTokenPairs: [["בכניסה", "בַּכְּנִיסָה"], ["לקניון", "לַקַּנְיוֹן"], ["יש", "יֵשׁ"], ["בידוק", "בִּידּוּק"]],
    englishTokens: ["At the entrance", "to the mall", "there is", "a security check"],
    hebrewDistractorPairs: [["ביציאה", "בַּיְּצִיאָה"], ["מהתחנה", "מֵהַתַּחֲנָה"], ["אין", "אֵין"], ["עוצר", "עוֹצֶר"]],
    englishDistractors: ["At the exit", "from the station", "there is no", "a curfew"],
    notes: "בידוק is the screening itself; the person doing it is a מאבטח."
  }),
  buildReviewedSentence({
    id: "idan_55", emoji: "🎒", category: "everyday", difficulty: 1,
    wordOrderDecision: "fixed",
    hebrew: "המאבטח ביקש לפתוח את התיק.", hebrewNiqqud: "הַמְאַבְטֵחַ בִּיקֵּשׁ לִפְתּוֹחַ אֶת הַתִּיק.",
    english: "The security guard asked to open the bag.",
    hebrewTokenPairs: [["המאבטח", "הַמְאַבְטֵחַ"], ["ביקש", "בִּיקֵּשׁ"], ["לפתוח", "לִפְתּוֹחַ"], ["את התיק", "אֶת הַתִּיק"]],
    englishTokens: ["The security guard", "asked", "to open", "the bag"],
    hebrewDistractorPairs: [["השוטר", "הַשּׁוֹטֵר"], ["סירב", "סֵירֵב"], ["לסגור", "לִסְגּוֹר"], ["את הדלת", "אֶת הַדֶּלֶת"]],
    englishDistractors: ["The police officer", "refused", "to close", "the door"],
    notes: "A מאבטח may ask; only a שוטר has powers of search and arrest."
  }),
  buildReviewedSentence({
    id: "idan_56", emoji: "📱", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "התקנתי את האפליקציה של פיקוד העורף.", hebrewNiqqud: "הִתְקַנְתִּי אֶת הָאַפְלִיקַצְיָה שֶׁל פִּיקּוּד הָעֹרֶף.",
  ...
  buildReviewedSentence({
    id: "idan_57", emoji: "🔔", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "קיבלתי התראה בטלפון על נפילה.", hebrewNiqqud: "קִיבַּלְתִּי הַתְרָאָה בַּטֶּלֶפוֹן עַל נְפִילָה.",
    english: "I got a notification on the phone about an impact.",
    hebrewTokenPairs: [["קיבלתי", "קִיבַּלְתִּי"], ["התראה", "הַתְרָאָה"], ["בטלפון", "בַּטֶּלֶפוֹן"], ["על נפילה", "עַל נְפִילָה"]],
    englishTokens: ["I got", "a notification", "on the phone", "about an impact"],
    hebrewDistractorPairs: [["שלחתי", "שָׁלַחְתִּי"], ["הודעה", "הוֹדָעָה"], ["במשרד", "בַּמִּשְׂרָד"], ["על רגיעה", "עַל רְגִיעָה"]],
    englishDistractors: ["I sent", "a message", "at the office", "about calm"],
    notes: "התראה is the push alert; נפילה is the impact itself in official wording."
  }),
  buildReviewedSentence({
    id: "idan_58", emoji: "🔑", category: "everyday", difficulty: 1,
    wordOrderDecision: "fixed",
    hebrew: "המפתח של המקלט אצל הוועד.", hebrewNiqqud: "הַמַּפְתֵּחַ שֶׁל הַמִּקְלָט אֵצֶל הַוַּועַד.",
    english: "The key of the shelter is with the committee.",
    hebrewTokenPairs: [["המפתח", "הַמַּפְתֵּחַ"], ["של המקלט", "שֶׁל הַמִּקְלָט"], ["אצל הוועד", "אֵצֶל הַוַּועַד"]],
    englishTokens: ["The key", "of the shelter", "is with the committee"],
    hebrewDistractorPairs: [["הקוד", "הַקּוֹד"], ["של השער", "שֶׁל הַשַּׁעַר"], ["אצל השכן", "אֵצֶל הַשָּׁכֵן"], ["בתיק", "בַּתִּיק"]],
    englishDistractors: ["The code", "of the gate", "with the neighbour", "in the bag"],
    notes: "ועד בית is the building committee; a locked מקלט is a common complaint."
  }),
  buildReviewedSentence({
    id: "idan_59", emoji: "🏃", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "תרגלנו את הדרך למרחב המוגן.", hebrewNiqqud: "תִּרְגַּלְנוּ אֶת הַדֶּרֶךְ לַמֶּרְחָב הַמּוּגָן.",
    english: "We practiced the way to the protected space.",
    hebrewTokenPairs: [["תרגלנו", "תִּרְגַּלְנוּ"], ["את הדרך", "אֶת הַדֶּרֶךְ"], ["למרחב המוגן", "לַמֶּרְחָב הַמּוּגָן"]],
    englishTokens: ["We practiced", "the way", "to the protected space"],
    hebrewDistractorPairs: [["שכחנו", "שָׁכַחְנוּ"], ["את הקוד", "אֶת הַקּוֹד"], ["לחדר המדרגות", "לַחֲדַר הַמַּדְרֵגוֹת"], ["למקלט", "לַמִּקְלָט"]],
    englishDistractors: ["We forgot", "the code", "to the stairwell", "to the shelter"],
    notes: "Walking the route once is the cheapest preparedness step there is."
  }),
  buildReviewedSentence({
    id: "idan_60", emoji: "📅", category: "everyday", difficulty: 3,
    wordOrderDecision: "fixed",
    hebrew: "בודקים את הממ״ד פעם בחודש.", hebrewNiqqud: "בּוֹדְקִים אֶת הַמַּמָּ״ד פַּעַם בְּחוֹדֶשׁ.",
    english: "We check the safe room monthly.",
    hebrewTokenPairs: [["בודקים", "בּוֹדְקִים"], ["את הממ״ד", "אֶת הַמַּמָּ״ד"], ["פעם בחודש", "פַּעַם בְּחוֹדֶשׁ"]],
    englishTokens: ["We check", "the safe room", "monthly"],
    hebrewDistractorPairs: [["פותחים", "פּוֹתְחִים"], ["את החלון", "אֶת הַחַלּוֹן"], ["פעם בשנה", "פַּעַם בְּשָׁנָה"], ["כל יום", "כָּל יוֹם"]],
    englishDistractors: ["We open", "the window", "yearly", "daily"],
    notes: "The seal and the window crank are what a monthly ממ״ד check is for."
  }),
  buildReviewedSentence({
    id: "idan_61", emoji: "📞", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "קיבלתי צו והודעתי למשפחה.", hebrewNiqqud: "קִיבַּלְתִּי צַו וְהוֹדַעְתִּי לַמִּשְׁפָּחָה.",
    english: "I got an order and told the family.",
    hebrewTokenPairs: [["קיבלתי", "קִיבַּלְתִּי"], ["צו", "צַו"], ["והודעתי", "וְהוֹדַעְתִּי"], ["למשפחה", "לַמִּשְׁפָּחָה"]],
    englishTokens: ["I got", "an order", "and told", "the family"],
    hebrewDistractorPairs: [["שלחתי", "שָׁלַחְתִּי"], ["טופס", "טוֹפֶס"], ["וחיכיתי", "וְחִיכִּיתִי"], ["למפקד", "לַמְּפַקֵּד"]],
    englishDistractors: ["I sent", "a form", "and waited", "for the commander"],
    notes: "צו alone is enough in speech; everyone understands צו 8 from context."
  }),
  buildReviewedSentence({
    ...
    notes: "Reserve call-ups are discussed in these domestic terms far more than tactical ones."
  }),
  buildReviewedSentence({
    id: "idan_63", emoji: "📝", category: "everyday", difficulty: 1,
    wordOrderDecision: "fixed",
    hebrew: "ביקשתי יציאה מהבסיס לשבת.", hebrewNiqqud: "בִּיקַּשְׁתִּי יְצִיאָה מֵהַבָּסִיס לְשַׁבָּת.",
    english: "I requested leave from the base for Shabbat.",
    hebrewTokenPairs: [["ביקשתי", "בִּיקַּשְׁתִּי"], ["יציאה", "יְצִיאָה"], ["מהבסיס", "מֵהַבָּסִיס"], ["לשבת", "לְשַׁבָּת"]],
    englishTokens: ["I requested", "leave", "from the base", "for Shabbat"],
    hebrewDistractorPairs: [["קיבלתי", "קִיבַּלְתִּי"], ["תורנות", "תּוֹרְנוּת"], ["מהמפקד", "מֵהַמְּפַקֵּד"], ["ליום ראשון", "לְיוֹם רִאשׁוֹן"]],
    englishDistractors: ["I got", "duty", "from the commander", "for Sunday"],
    notes: "יציאה is the everyday word for leave; חופשה is the longer formal kind."
  }),
  buildReviewedSentence({
    id: "idan_64", emoji: "🚌", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "חזרתי לבסיס ביום ראשון בבוקר.", hebrewNiqqud: "חָזַרְתִּי לַבָּסִיס בְּיוֹם רִאשׁוֹן בַּבֹּקֶר.",
    english: "I returned to the base on Sunday in the morning.",
    hebrewTokenPairs: [["חזרתי", "חָזַרְתִּי"], ["לבסיס", "לַבָּסִיס"], ["ביום ראשון", "בְּיוֹם רִאשׁוֹן"], ["בבוקר", "בַּבֹּקֶר"]],
    englishTokens: ["I returned", "to the base", "on Sunday", "in the morning"],
    hebrewDistractorPairs: [["נשארתי", "נִשְׁאַרְתִּי"], ["במחנה", "בַּמַּחֲנֶה"], ["ביום שישי", "בְּיוֹם שִׁישִׁי"], ["בלילה", "בַּלַּיְלָה"]],
    englishDistractors: ["I stayed", "at the camp", "on Friday", "at night"],
    notes: "Sunday is the first working day, so it is when most reservists report."
  }),
  buildReviewedSentence({
    id: "idan_65", emoji: "🎖️", category: "everyday", difficulty: 3,
    wordOrderDecision: "fixed",
    hebrew: "שאלתי את הקצין מה הנוהל.", hebrewNiqqud: "שָׁאַלְתִּי אֶת הַקָּצִין מָה הַנּוֹהַל.",
    english: "I asked the officer what the procedure is.",
    hebrewTokenPairs: [["שאלתי", "שָׁאַלְתִּי"], ["את הקצין", "אֶת הַקָּצִין"], ["מה", "מָה"], ["הנוהל", "הַנּוֹהַל"]],
    englishTokens: ["I asked", "the officer", "what", "the procedure is"],
    hebrewDistractorPairs: [["ענה", "עָנָה"], ["את הסמל", "אֶת הַסַּמָּל"], ["למה", "לָמָּה"], ["התדריך", "הַתַּדְרִיךְ"]],
    englishDistractors: ["He answered", "the sergeant", "why", "the briefing is"],
    notes: "נוהל is a written standing procedure; פקודה is a specific order."
  }),
  buildReviewedSentence({
    id: "idan_66", emoji: "📋", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "פקודות הקבע תלויות על הלוח.", hebrewNiqqud: "פְּקוּדּוֹת הַקֶּבַע תְּלוּיוֹת עַל הַלּוּחַ.",
    english: "The standing orders are posted on the board.",
    hebrewTokenPairs: [["פקודות הקבע", "פְּקוּדּוֹת הַקֶּבַע"], ["תלויות", "תְּלוּיוֹת"], ["על הלוח", "עַל הַלּוּחַ"]],
    englishTokens: ["The standing orders", "are posted", "on the board"],
    hebrewDistractorPairs: [["הערכת המצב", "הַעֲרָכַת הַמַּצָּב"], ["נשארה", "נִשְׁאֲרָה"], ["במשרד", "בַּמִּשְׂרָד"], ["בתיק", "בַּתִּיק"]],
    englishDistractors: ["The situation assessment", "stayed", "at the office", "in the bag"],
    notes: "פקודות קבע are permanent; a פקודת מבצע applies to one operation."
  }),
  buildReviewedSentence({
    id: "idan_67", emoji: "🌙", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "התורנות שלי מתחילה בחצות.", hebrewNiqqud: "הַתּוֹרְנוּת שֶׁלִּי מַתְחִילָה בַּחֲצוֹת.",
    english: "My shift starts at midnight.",
    hebrewTokenPairs: [["התורנות שלי", "הַתּוֹרְנוּת שֶׁלִּי"], ["מתחילה", "מַתְחִילָה"], ["בחצות", "בַּחֲצוֹת"]],
    englishTokens: ["My shift", "starts", "at midnight"],
    hebrewDistractorPairs: [["המסדר שלנו", "הַמִּסְדָּר שֶׁלָּנוּ"], ["נגמרת", "נִגְמֶרֶת"], ["בבוקר", "בַּבֹּקֶר"], ["בצהריים", "בַּצָּהֳרַיִים"]],
    englishDistractors: ["Our parade", "ends", "in the morning", "at noon"],
    notes: "תורנות is any duty rotation; תורנות שמירה is specifically guard duty."
  }),
  buildReviewedSentence({
  ...
  buildReviewedSentence({
    id: "idan_69", emoji: "🎽", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "קיבלתי אפוד וקסדה באפסנאות.", hebrewNiqqud: "קִיבַּלְתִּי אֲפוֹד וְקַסְדָּה בָּאַפְסְנָאוּת.",
    english: "I received a vest and a helmet at the stores.",
    hebrewTokenPairs: [["קיבלתי", "קִיבַּלְתִּי"], ["אפוד", "אֲפוֹד"], ["וקסדה", "וְקַסְדָּה"], ["באפסנאות", "בָּאַפְסְנָאוּת"]],
    englishTokens: ["I received", "a vest", "and a helmet", "at the stores"],
    hebrewDistractorPairs: [["החזרתי", "הֶחְזַרְתִּי"], ["מדים", "מַדִּים"], ["וכומתה", "וְכוּמְתָּה"], ["בשלישות", "בַּשְּׁלִישׁוּת"]],
    englishDistractors: ["I returned", "a uniform", "and a beret", "at the adjutancy"],
    notes: "אפסנאות issues kit; שלישות handles paperwork. Learners mix the two."
  }),
  buildReviewedSentence({
    id: "idan_70", emoji: "📦", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "החזרתי את הציוד לפני השחרור.", hebrewNiqqud: "הֶחְזַרְתִּי אֶת הַצִּיּוּד לִפְנֵי הַשִּׁחְרוּר.",
    english: "I returned the equipment before the discharge.",
    hebrewTokenPairs: [["החזרתי", "הֶחְזַרְתִּי"], ["את הציוד", "אֶת הַצִּיּוּד"], ["לפני השחרור", "לִפְנֵי הַשִּׁחְרוּר"]],
    englishTokens: ["I returned", "the equipment", "before the discharge"],
    hebrewDistractorPairs: [["קיבלתי", "קִיבַּלְתִּי"], ["את המצפן", "אֶת הַמַּצְפֵּן"], ["אחרי הגיוס", "אַחֲרֵי הַגִּיּוּס"], ["בזמן התרגיל", "בִּזְמַן הַתַּרְגִּיל"]],
    englishDistractors: ["I received", "the compass", "after the conscription", "during the exercise"],
    notes: "You cannot get a תעודת שחרור until אפסנאות signs off on the kit."
  }),
  buildReviewedSentence({
    id: "idan_71", emoji: "📡", category: "everyday", difficulty: 3,
    wordOrderDecision: "fixed",
    hebrew: "דיווחתי למפקד לפני שהמשכנו.", hebrewNiqqud: "דִּיוַּוחְתִּי לַמְּפַקֵּד לִפְנֵי שֶׁהִמְשַׁכְנוּ.",
    english: "I reported to the commander before we continued.",
    hebrewTokenPairs: [["דיווחתי", "דִּיוַּוחְתִּי"], ["למפקד", "לַמְּפַקֵּד"], ["לפני שהמשכנו", "לִפְנֵי שֶׁהִמְשַׁכְנוּ"]],
    englishTokens: ["I reported", "to the commander", "before we continued"],
    hebrewDistractorPairs: [["שכחתי", "שָׁכַחְתִּי"], ["לסמל", "לַסַּמָּל"], ["אחרי שחזרנו", "אַחֲרֵי שֶׁחָזַרְנוּ"], ["בלי לשאול", "בְּלִי לִשְׁאוֹל"]],
    englishDistractors: ["I forgot", "to the sergeant", "after we returned", "without asking"],
    notes: "Reporting up before acting is the habit פקודות קבע are written to create."
  }),
  buildReviewedSentence({
  ...
  buildReviewedSentence({
    id: "idan_73", emoji: "🗓️", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "התרגיל נמשך שבוע בשטח.", hebrewNiqqud: "הַתַּרְגִּיל נִמְשַׁךְ שָׁבוּעַ בַּשֶּׁטַח.",
    english: "The exercise lasted a week in the field.",
    hebrewTokenPairs: [["התרגיל", "הַתַּרְגִּיל"], ["נמשך", "נִמְשַׁךְ"], ["שבוע", "שָׁבוּעַ"], ["בשטח", "בַּשֶּׁטַח"]],
    englishTokens: ["The exercise", "lasted", "a week", "in the field"],
    hebrewDistractorPairs: [["המבצע", "הַמִּבְצָע"], ["הסתיים", "הִסְתַּיֵּים"], ["יום אחד", "יוֹם אֶחָד"], ["בבסיס", "בַּבָּסִיס"]],
    englishDistractors: ["The operation", "ended", "one day", "at the base"],
    notes: "בשטח means out in the field, and by extension anything hands-on."
  }),
  buildReviewedSentence({
    id: "idan_74", emoji: "🔒", category: "everyday", difficulty: 3,
    wordOrderDecision: "fixed",
    hebrew: "לפני אש חיה יש תדריך בטיחות.", hebrewNiqqud: "לִפְנֵי אֵשׁ חַיָּה יֵשׁ תַּדְרִיךְ בְּטִיחוּת.",
    english: "Before live fire there is a safety briefing.",
    hebrewTokenPairs: [["לפני אש חיה", "לִפְנֵי אֵשׁ חַיָּה"], ["יש", "יֵשׁ"], ["תדריך בטיחות", "תַּדְרִיךְ בְּטִיחוּת"]],
    englishTokens: ["Before live fire", "there is", "a safety briefing"],
    hebrewDistractorPairs: [["אחרי המסדר", "אַחֲרֵי הַמִּסְדָּר"], ["אין", "אֵין"], ["תחקיר", "תַּחְקִיר"], ["נוהל", "נוֹהַל"]],
    englishDistractors: ["After the parade", "there is no", "a debrief", "a procedure"],
    notes: "The safety briefing is a נוהל, not a courtesy; nothing starts without it."
  }),
  buildReviewedSentence({
    ...
    notes: "שלישות is the personnel office; every service question starts there."
  }),
  buildReviewedSentence({
    id: "idan_76", emoji: "📜", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "תעודת השחרור הגיעה בדואר.", hebrewNiqqud: "תְּעוּדַת הַשִּׁחְרוּר הִגִּיעָה בַּדּוֹאַר.",
    english: "The discharge certificate arrived in the mail.",
    hebrewTokenPairs: [["תעודת השחרור", "תְּעוּדַת הַשִּׁחְרוּר"], ["הגיעה", "הִגִּיעָה"], ["בדואר", "בַּדּוֹאַר"]],
    englishTokens: ["The discharge certificate", "arrived", "in the mail"],
    hebrewDistractorPairs: [["פנקס המילואים", "פִּנְקַס הַמִּילּוּאִים"], ["נשאר", "נִשְׁאַר"], ["בבית", "בַּבַּיִת"], ["במשרד", "בַּמִּשְׂרָד"]],
    englishDistractors: ["The booklet", "stayed", "at home", "at the office"],
    notes: "תעודת שחרור is needed for university discounts and many benefits."
  }),
  buildReviewedSentence({
    id: "idan_77", emoji: "🩺", category: "everyday", difficulty: 3,
    wordOrderDecision: "fixed",
    hebrew: "הוועדה הרפואית קבעה לי פרופיל.", hebrewNiqqud: "הַוַּועֲדָה הָרְפוּאִית קָבְעָה לִי פְּרוֹפִיל.",
    english: "The medical board set for me a profile.",
    hebrewTokenPairs: [["הוועדה הרפואית", "הַוַּועֲדָה הָרְפוּאִית"], ["קבעה", "קָבְעָה"], ["לי", "לִי"], ["פרופיל", "פְּרוֹפִיל"]],
    englishTokens: ["The medical board", "set", "for me", "a profile"],
    hebrewDistractorPairs: [["השלישות", "הַשְּׁלִישׁוּת"], ["ביטלה", "בִּיטְּלָה"], ["לנו", "לָנוּ"], ["תורנות", "תּוֹרְנוּת"]],
    englishDistractors: ["The adjutancy", "cancelled", "for us", "duty"],
    notes: "פרופיל is the medical fitness score; 97 is the top and 21 exempts."
  }),
  buildReviewedSentence({
    id: "idan_78", emoji: "⏳", category: "everyday", difficulty: 3,
    wordOrderDecision: "fixed",
    hebrew: "ביקשתי דחיית שירות בגלל הלימודים.", hebrewNiqqud: "בִּיקַּשְׁתִּי דְּחִיַּית שֵׁירוּת בִּגְלַל הַלִּימּוּדִים.",
    english: "I requested a service deferral because of studies.",
    hebrewTokenPairs: [["ביקשתי", "בִּיקַּשְׁתִּי"], ["דחיית שירות", "דְּחִיַּית שֵׁירוּת"], ["בגלל הלימודים", "בִּגְלַל הַלִּימּוּדִים"]],
    englishTokens: ["I requested", "a service deferral", "because of studies"],
    hebrewDistractorPairs: [["קיבלתי", "קִיבַּלְתִּי"], ["פטור רפואי", "פְּטוֹר רְפוּאִי"], ["בזכות הוותק", "בִּזְכוּת הַוֶּתֶק"], ["בלי סיבה", "בְּלִי סִיבָּה"]],
    englishDistractors: ["I received", "a medical exemption", "with seniority", "without reason"],
    notes: "דחייה postpones service; פטור cancels it, and the two are not synonyms."
  }),
  buildReviewedSentence({
    id: "idan_79", emoji: "🍽️", category: "everyday", difficulty: 1,
    wordOrderDecision: "fixed",
    hebrew: "היום יש לי תורנות מטבח.", hebrewNiqqud: "הַיּוֹם יֵשׁ לִי תּוֹרְנוּת מִטְבָּח.",
    english: "Today I have kitchen duty.",
    hebrewTokenPairs: [["היום", "הַיּוֹם"], ["יש לי", "יֵשׁ לִי"], ["תורנות מטבח", "תּוֹרְנוּת מִטְבָּח"]],
    englishTokens: ["Today", "I have", "kitchen duty"],
    hebrewDistractorPairs: [["מחר", "מָחָר"], ["אין לי", "אֵין לִי"], ["תורנות שמירה", "תּוֹרְנוּת שְׁמִירָה"], ["מסדר בוקר", "מִסְדַּר בֹּקֶר"]],
    englishDistractors: ["Tomorrow", "I don't have", "guard duty", "a parade"],
    notes: "תורנות מטבח is the archetypal chore, and the source of endless slang."
  }),
  buildReviewedSentence({
    id: "idan_80", emoji: "🥗", category: "everyday", difficulty: 1,
    wordOrderDecision: "fixed",
    hebrew: "חדר האוכל נפתח בשבע בבוקר.", hebrewNiqqud: "חֲדַר הָאוֹכֶל נִפְתָּח בְּשֶׁבַע בַּבֹּקֶר.",
    english: "The mess hall opens at seven in the morning.",
    hebrewTokenPairs: [["חדר האוכל", "חֲדַר הָאוֹכֶל"], ["נפתח", "נִפְתָּח"], ["בשבע", "בְּשֶׁבַע"], ["בבוקר", "בַּבֹּקֶר"]],
    englishTokens: ["The mess hall", "opens", "at seven", "in the morning"],
    hebrewDistractorPairs: [["המרפאה", "הַמִּרְפָּאָה"], ["נסגרת", "נִסְגֶּרֶת"], ["בשמונה", "בִּשְׁמוֹנֶה"], ["בערב", "בָּעֶרֶב"]],
    englishDistractors: ["The clinic", "closes", "at eight", "in the evening"],
    notes: "חדר אוכל is the mess hall on a base and the dining hall on a kibbutz."
  }),
  buildReviewedSentence({
    id: "idan_81", emoji: "🪖", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "לבשתי מדים וחבשתי כומתה.", hebrewNiqqud: "לָבַשְׁתִּי מַדִּים וְחָבַשְׁתִּי כּוּמְתָּה.",
    english: "I wore a uniform and put on a beret.",
    hebrewTokenPairs: [["לבשתי", "לָבַשְׁתִּי"], ["מדים", "מַדִּים"], ["וחבשתי", "וְחָבַשְׁתִּי"], ["כומתה", "כּוּמְתָּה"]],
    englishTokens: ["I wore", "a uniform", "and put on", "a beret"],
    hebrewDistractorPairs: [["קיבלתי", "קִיבַּלְתִּי"], ["אפוד", "אֲפוֹד"], ["והחזרתי", "וְהֶחְזַרְתִּי"], ["דיסקית", "דִּיסְקִית"]],
    englishDistractors: ["I received", "a vest", "and returned", "a dog tag"],
    notes: "ללבוש for clothes, לחבוש for anything on the head. The pair is tested often."
  }),
  buildReviewedSentence({
    id: "idan_82", emoji: "🧭", category: "everyday", difficulty: 3,
    wordOrderDecision: "fixed",
    hebrew: "בניווט השתמשנו במצפן ובמפה.", hebrewNiqqud: "בַּנִּיווּט הִשְׁתַּמַּשְׁנוּ בְּמַצְפֵּן וּבְמַפָּה.",
    english: "In navigation we used a compass and a map.",
    hebrewTokenPairs: [["בניווט", "בַּנִּיווּט"], ["השתמשנו", "הִשְׁתַּמַּשְׁנוּ"], ["במצפן", "בְּמַצְפֵּן"], ["ובמפה", "וּבְמַפָּה"]],
    englishTokens: ["In navigation", "we used", "a compass", "and a map"],
    hebrewDistractorPairs: [["בתרגיל", "בַּתַּרְגִּיל"], ["ויתרנו", "וִיתַּרְנוּ"], ["על הקשר", "עַל הַקֶּשֶׁר"], ["ועל הציר", "וְעַל הַצִּיר"]],
    englishDistractors: ["In the exercise", "we gave up", "on the radio", "and on the route"],
    notes: "ניווט on foot with מצפן ומפה is a rite of passage in training."
  }),
  buildReviewedSentence({
    id: "idan_83", emoji: "🌡️", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "בשטח ישנתי בשק שינה.", hebrewNiqqud: "בַּשֶּׁטַח יָשַׁנְתִּי בְּשַׂק שֵׁינָה.",
    english: "In the field I slept in a sleeping bag.",
    hebrewTokenPairs: [["בשטח", "בַּשֶּׁטַח"], ["ישנתי", "יָשַׁנְתִּי"], ["בשק שינה", "בְּשַׂק שֵׁינָה"]],
    englishTokens: ["In the field", "I slept", "in a sleeping bag"],
    hebrewDistractorPairs: [["בבסיס", "בַּבָּסִיס"], ["התעוררתי", "הִתְעוֹרַרְתִּי"], ["במיטה", "בַּמִּיטָּה"], ["באוהל", "בָּאוֹהֶל"]],
    englishDistractors: ["At the base", "I woke up", "in a bed", "in a tent"],
    notes: "שק שינה is standard field kit, issued alongside the מימייה."
  }),
  buildReviewedSentence({
    id: "idan_84", emoji: "🥫", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "אכלנו מנות קרב כל היום.", hebrewNiqqud: "אָכַלְנוּ מָנוֹת קְרָב כָּל הַיּוֹם.",
    english: "We ate field rations all day.",
    hebrewTokenPairs: [["אכלנו", "אָכַלְנוּ"], ["מנות קרב", "מָנוֹת קְרָב"], ["כל היום", "כָּל הַיּוֹם"]],
    englishTokens: ["We ate", "field rations", "all day"],
    hebrewDistractorPairs: [["בישלנו", "בִּישַּׁלְנוּ"], ["ארוחה חמה", "אֲרוּחָה חַמָּה"], ["כל הלילה", "כָּל הַלַּיְלָה"], ["בחדר האוכל", "בַּחֲדַר הָאוֹכֶל"]],
    englishDistractors: ["We cooked", "a meal", "all night", "in the mess hall"],
    notes: "מנת קרב is the ration pack; the plural מנות קרב is how it is said."
  }),
  buildReviewedSentence({
    id: "idan_85", emoji: "💪", category: "everyday", difficulty: 3,
    wordOrderDecision: "fixed",
    hebrew: "הגיבוש נמשך שלושה ימים.", hebrewNiqqud: "הַגִּיבּוּשׁ נִמְשַׁךְ שְׁלוֹשָׁה יָמִים.",
    english: "The selection lasted three days.",
    hebrewTokenPairs: [["הגיבוש", "הַגִּיבּוּשׁ"], ["נמשך", "נִמְשַׁךְ"], ["שלושה", "שְׁלוֹשָׁה"], ["ימים", "יָמִים"]],
    englishTokens: ["The selection", "lasted", "three", "days"],
    hebrewDistractorPairs: [["הטירונות", "הַטִּירוֹנוּת"], ["הסתיימה", "הִסְתַּיְּימָה"], ["בשבוע", "בְּשָׁבוּעַ"], ["בחודש", "בְּחוֹדֶשׁ"]],
    englishDistractors: ["The basic training", "ended", "in a week", "in a month"],
    notes: "גיבוש is the selection tryout for a unit, before טירונות begins."
  }),
  buildReviewedSentence({
    id: "idan_86", emoji: "🎓", category: "everyday", difficulty: 3,
    wordOrderDecision: "fixed",
    hebrew: "התקבלתי לקורס קצינים בקיץ.", hebrewNiqqud: "הִתְקַבַּלְתִּי לְקוּרְס קְצִינִים בַּקַּיִץ.",
    english: "I was accepted to the officers' course in the summer.",
    hebrewTokenPairs: [["התקבלתי", "הִתְקַבַּלְתִּי"], ["לקורס קצינים", "לְקוּרְס קְצִינִים"], ["בקיץ", "בַּקַּיִץ"]],
    englishTokens: ["I was accepted", "to the officers' course", "in the summer"],
    hebrewDistractorPairs: [["סירבתי", "סֵירַבְתִּי"], ["למסלול חדש", "לְמַסְלוּל חָדָשׁ"], ["בחורף", "בַּחוֹרֶף"], ["באביב", "בָּאָבִיב"]],
    englishDistractors: ["I refused", "to a track", "in the winter", "in the spring"],
    notes: "קורס קצינים, usually shortened to קורס, is the officers' course at Bahad 1."
  }),
  buildReviewedSentence({
    id: "idan_87", emoji: "🤝", category: "everyday", difficulty: 2,
    wordOrderDecision: "fixed",
    hebrew: "בטקס ההשבעה ההורים הגיעו.", hebrewNiqqud: "בְּטֶקֶס הַהַשְׁבָּעָה הַהוֹרִים הִגִּיעוּ.",
    english: "At the swearing-in ceremony the parents arrived.",
    hebrewTokenPairs: [["בטקס ההשבעה", "בְּטֶקֶס הַהַשְׁבָּעָה"], ["ההורים", "הַהוֹרִים"], ["הגיעו", "הִגִּיעוּ"]],
    englishTokens: ["At the swearing-in ceremony", "the parents", "arrived"],
    hebrewDistractorPairs: [["במסדר הבוקר", "בַּמִּסְדָּר הַבֹּקֶר"], ["המפקדים", "הַמְּפַקְּדִים"], ["איחרו", "אִיחֲרוּ"], ["חיכו", "חִיכּוּ"]],
    englishDistractors: ["At the parade", "the commanders", "were late", "waited"],
    notes: "טקס השבעה closes basic training and is a major family occasion."
  }),
  buildReviewedSentence({
    id: "idan_88", emoji: "🎺", category: "everyday", difficulty: 1,
    wordOrderDecision: "fixed",
    hebrew: "המסדר התחיל בשש בדיוק.", hebrewNiqqud: "הַמִּסְדָּר הִתְחִיל בְּשֵׁשׁ בְּדִיּוּק.",
    english: "The parade started at six exactly.",
    hebrewTokenPairs: [["המסדר", "הַמִּסְדָּר"], ["התחיל", "הִתְחִיל"], ["בשש", "בְּשֵׁשׁ"], ["בדיוק", "בְּדִיּוּק"]],
    englishTokens: ["The parade", "started", "at six", "exactly"],
    hebrewDistractorPairs: [["התדריך", "הַתַּדְרִיךְ"], ["נדחה", "נִדְחָה"], ["בשבע", "בְּשֶׁבַע"], ["בערך", "בְּעֵרֶךְ"]],
    englishDistractors: ["The briefing", "was postponed", "at seven", "approximately"],
    notes: "מסדר is the formation; בדיוק is the word that always follows the hour."
  }),
  buildReviewedSentence({
    id: "idan_89", emoji: "📈", category: "everyday", difficulty: 3,
    wordOrderDecision: "fixed",
    hebrew: "בזכות הוותק קיבלתי דרגה.", hebrewNiqqud: "בִּזְכוּת הַוֶּתֶק קִיבַּלְתִּי דַּרְגָּה.",
    english: "With seniority I received a rank.",
    hebrewTokenPairs: [["בזכות הוותק", "בִּזְכוּת הַוֶּתֶק"], ["קיבלתי", "קִיבַּלְתִּי"], ["דרגה", "דַּרְגָּה"]],
    englishTokens: ["With seniority", "I received", "a rank"],
    hebrewDistractorPairs: [["בגלל התחקיר", "בִּגְלַל הַתַּחְקִיר"], ["איבדתי", "אִיבַּדְתִּי"], ["תפקיד", "תַּפְקִיד"], ["חופשה", "חוּפְשָׁה"]],
    englishDistractors: ["Because of the debrief", "I lost", "a role", "leave"],
    notes: "ותק drives promotion in the reserves as much as performance does."
  }),
  buildReviewedSentence({
    id: "idan_90", emoji: "🔍", category: "everyday", difficulty: 3,
    wordOrderDecision: "fixed",
    hebrew: "מסקנות התחקיר שינו את הנוהל.", hebrewNiqqud: "מַסְקָנוֹת הַתַּחְקִיר שִׁינּוּ אֶת הַנּוֹהַל.",
    english: "The conclusions of the debrief changed the procedure.",
    hebrewTokenPairs: [["מסקנות", "מַסְקָנוֹת"], ["התחקיר", "הַתַּחְקִיר"], ["שינו", "שִׁינּוּ"], ["את הנוהל", "אֶת הַנּוֹהַל"]],
    englishTokens: ["The conclusions", "of the debrief", "changed", "the procedure"],
    hebrewDistractorPairs: [["דברי התדריך", "דִּבְרֵי הַתַּדְרִיךְ"], ["ביטלו", "בִּיטְּלוּ"], ["את הפקודה", "אֶת הַפְּקוּדָּה"], ["את המסדר", "אֶת הַמִּסְדָּר"]],
