...
const IDAN_SENTENCES = [
  ...
  buildReviewedSentence({
    ...
    wordOrderDecision: "fixed",
    hebrew: "המשפחה קיבלה מגורים זמניים לחודש.", hebrewNiqqud: "הַמִּשְׁפָּחָה קִיבְּלָה מְגוּרִים זְמַנִּיִּים לְחֹודֶשׁ.",
    english: "The family received temporary housing for a month.",
    hebrewTokenPairs: [["המשפחה", "הַמִּשְׁפָּחָה"], ["קיבלה", "קִיבְּלָה"], ["מגורים זמניים", "מְגוּרִים זְמַנִּיִּים"], ["לחודש", "לְחֹודֶשׁ"]],
  ...
  buildReviewedSentence({
    ...
    wordOrderDecision: "fixed",
    hebrew: "צריך ללחוץ חזק על הפצע.", hebrewNiqqud: "צָרִיךְ לִלְחֹוץ חָזָק עַל הַפֶּצַע.",
    english: "We need to press hard on the wound.",
    hebrewTokenPairs: [["צריך", "צָרִיךְ"], ["ללחוץ", "לִלְחֹוץ"], ["חזק", "חָזָק"], ["על הפצע", "עַל הַפֶּצַע"]],
    englishTokens: ["We need", "to press", "hard", "on the wound"],
    hebrewDistractorPairs: [["אסור", "אָסוּר"], ["לשטוף", "לִשְׁטֹוף"], ["מהר", "מַהֵר"], ["את הידיים", "אֶת הַיָּדַיִים"]],
  ...
  buildReviewedSentence({
    ...
    hebrewDistractorPairs: [["עוברים", "עוֹבְרִים"], ["את הגשר", "אֶת הַגֶּשֶׁר"], ["תמיד", "תָּמִיד"], ["ברמזור אדום", "בְּרַמְזוֹר אָדֹום"]],
  ...
  buildReviewedSentence({
    ...
    wordOrderDecision: "fixed",
    hebrew: "באתר בנייה חובה לחבוש קסדה.", hebrewNiqqud: "בְּאֲתַר בְּנִיָּיה חוֹבָה לַחְבֹּוש קַסְדָּה.",
    english: "At a site it is required to wear a helmet.",
    hebrewTokenPairs: [["באתר בנייה", "בְּאֲתַר בְּנִיָּיה"], ["חובה", "חוֹבָה"], ["לחבוש", "לַחְבֹּוש"], ["קסדה", "קַסְדָּה"]],
  ...
  buildReviewedSentence({
    ...
    hebrewDistractorPairs: [["כדאי", "כְּדַאי"], ["לבדוק", "לִבְדֹּוק"], ["את המטען", "אֶת הַמַּטְעָן"], ["בבית חם", "בְּבַיִת חַם"]],
  ...
  buildReviewedSentence({
    ...
    wordOrderDecision: "fixed",
    hebrew: "כשמתקשרים למוקד אומרים את הכתובת.", hebrewNiqqud: "כְּשֶׁמִּתְקַשְּׁרִים לַמּוֹקֵד אוֹמְרִים אֶת הַכְּתֹובֶת.",
    english: "When calling the center we give the address.",
    hebrewTokenPairs: [["כשמתקשרים", "כְּשֶׁמִּתְקַשְּׁרִים"], ["למוקד", "לַמּוֹקֵד"], ["אומרים", "אוֹמְרִים"], ["את הכתובת", "אֶת הַכְּתֹובֶת"]],
  ...
  buildReviewedSentence({
    ...
    hebrewDistractorPairs: [["לפני ההודעה", "לִפְנֵי הַהוֹדָעָה"], ["שכחתי", "שָׁכַחְתִּי"], ["רגיעה", "רְגִיעָה"], ["חוסן", "חֹוסֶן"]],
  ...
  buildReviewedSentence({
    ...
    wordOrderDecision: "fixed",
    hebrew: "מרכז החוסן עוזר למשפחות באזור.", hebrewNiqqud: "מֶרְכַּז הַחֹוסֶן עוֹזֵר לְמִשְׁפָּחוֹת בָּאֵזוֹר.",
    english: "The resilience center helps families in the area.",
    hebrewTokenPairs: [["מרכז החוסן", "מֶרְכַּז הַחֹוסֶן"], ["עוזר", "עוֹזֵר"], ["למשפחות", "לְמִשְׁפָּחוֹת"], ["באזור", "בָּאֵזוֹר"]],
  ...
  buildReviewedSentence({
    ...
    wordOrderDecision: "fixed",
    hebrew: "המאבטח ביקש לפתוח את התיק.", hebrewNiqqud: "הַמְאַבְטֵחַ בִּיקֵּשׁ לִפְתֹּוחַ אֶת הַתִּיק.",
    english: "The security guard asked to open the bag.",
    hebrewTokenPairs: [["המאבטח", "הַמְאַבְטֵחַ"], ["ביקש", "בִּיקֵּשׁ"], ["לפתוח", "לִפְתֹּוחַ"], ["את התיק", "אֶת הַתִּיק"]],
    englishTokens: ["The security guard", "asked", "to open", "the bag"],
    hebrewDistractorPairs: [["השוטר", "הַשּׁוֹטֵר"], ["סירב", "סֵירֵב"], ["לסגור", "לִסְגֹּור"], ["את הדלת", "אֶת הַדֶּלֶת"]],
  ...
  buildReviewedSentence({
    ...
    wordOrderDecision: "fixed",
    hebrew: "בודקים את הממ״ד פעם בחודש.", hebrewNiqqud: "בּוֹדְקִים אֶת הַמַּמָּ״ד פַּעַם בְּחֹודֶשׁ.",
    english: "We check the safe room monthly.",
    hebrewTokenPairs: [["בודקים", "בּוֹדְקִים"], ["את הממ״ד", "אֶת הַמַּמָּ״ד"], ["פעם בחודש", "פַּעַם בְּחֹודֶשׁ"]],
  ...
  buildReviewedSentence({
    ...
    hebrewDistractorPairs: [["שלחתי", "שָׁלַחְתִּי"], ["טופס", "טֹופֶס"], ["וחיכיתי", "וְחִיכִּיתִי"], ["למפקד", "לַמְּפַקֵּד"]],
  ...
  buildReviewedSentence({
    ...
    hebrewDistractorPairs: [["נשארתי", "נִשְׁאַרְתִּי"], ["במחנה", "בַּמַּחֲנֶה"], ["ביום שישי", "בְּיוֹם שִׁישִּׁי"], ["בלילה", "בַּלַּיְלָה"]],
  ...
  buildReviewedSentence({
    ...
    wordOrderDecision: "fixed",
    hebrew: "העברתי את המשמרת לחייל הבא.", hebrewNiqqud: "הֶעֱבַרְתִּי אֶת הַמִּשְׁמֶרֶת לַחַיָּיל הַבָּא.",
    english: "I handed the shift to the soldier.",
    hebrewTokenPairs: [["העברתי", "הֶעֱבַרְתִּי"], ["את המשמרת", "אֶת הַמִּשְׁמֶרֶת"], ["לחייל הבא", "לַחַיָּיל הַבָּא"]],
    englishTokens: ["I handed", "the shift", "to the soldier"],
    hebrewDistractorPairs: [["איבדתי", "אִיבַּדְתִּי"], ["את הציוד", "אֶת הַצִּיּוּד"], ["למפקד הפלוגה", "לִמְפַקֵּד הַפְּלוּגָה"], ["לסמל", "לַסַּמָּל"]],
  ...
  buildReviewedSentence({
    ...
    hebrewDistractorPairs: [["שכחתי", "שָׁכַחְתִּי"], ["לסמל", "לַסַּמָּל"], ["אחרי שחזרנו", "אַחֲרֵי שֶׁחָזַרְנוּ"], ["בלי לשאול", "בְּלִי לִשְׁאֹול"]],
  ...
  buildReviewedSentence({
    ...
    wordOrderDecision: "fixed",
    hebrew: "בשלישות מלאתי טופס וחתמתי.", hebrewNiqqud: "בַּשְּׁלִישׁוּת מִילֵּאתִי טֹופֶס וְחָתַמְתִּי.",
    english: "At the adjutancy I filled a form and signed.",
    hebrewTokenPairs: [["בשלישות", "בַּשְּׁלִישׁוּת"], ["מלאתי", "מִילֵּאתִי"], ["טופס", "טֹופֶס"], ["וחתמתי", "וְחָתַמְתִּי"]],
  ...
  buildReviewedSentence({
    ...
    wordOrderDecision: "fixed",
    hebrew: "תעודת השחרור הגיעה בדואר.", hebrewNiqqud: "תְּעוּדַת הַשִּׁחְרוּר הִגִּיעָה בַּדֹּואַר.",
    english: "The discharge certificate arrived in the mail.",
    hebrewTokenPairs: [["תעודת השחרור", "תְּעוּדַת הַשִּׁחְרוּר"], ["הגיעה", "הִגִּיעָה"], ["בדואר", "בַּדֹּואַר"]],
  ...
  buildReviewedSentence({
    ...
    wordOrderDecision: "fixed",
    hebrew: "חדר האוכל נפתח בשבע בבוקר.", hebrewNiqqud: "חֲדַר הָאֹוכֶל נִפְתָּח בְּשֶׁבַע בַּבֹּקֶר.",
    english: "The mess hall opens at seven in the morning.",
    hebrewTokenPairs: [["חדר האוכל", "חֲדַר הָאֹוכֶל"], ["נפתח", "נִפְתָּח"], ["בשבע", "בְּשֶׁבַע"], ["בבוקר", "בַּבֹּקֶר"]],
  ...
  buildReviewedSentence({
    ...
    hebrewDistractorPairs: [["בבסיס", "בַּבָּסִיס"], ["התעוררתי", "הִתְעוֹרַרְתִּי"], ["במיטה", "בַּמִּיטָּה"], ["באוהל", "בָּאֹוהֶל"]],
  ...
  buildReviewedSentence({
    ...
    wordOrderDecision: "fixed",
    hebrew: "אכלנו מנות קרב כל היום.", hebrewNiqqud: "אָכַלְנוּ מְנוֹת קְרָב כָּל הַיּוֹם.",
    english: "We ate field rations all day.",
    hebrewTokenPairs: [["אכלנו", "אָכַלְנוּ"], ["מנות קרב", "מְנוֹת קְרָב"], ["כל היום", "כָּל הַיּוֹם"]],
    englishTokens: ["We ate", "field rations", "all day"],
    hebrewDistractorPairs: [["בישלנו", "בִּישַּׁלְנוּ"], ["ארוחה חמה", "אֲרוּחָה חַמָּה"], ["כל הלילה", "כָּל הַלַּיְלָה"], ["בחדר האוכל", "בַּחֲדַר הָאֹוכֶל"]],
  ...
  buildReviewedSentence({
    ...
    hebrewDistractorPairs: [["הטירונות", "הַטִּירוֹנוּת"], ["הסתיימה", "הִסְתַּיְּימָה"], ["בשבוע", "בְּשָׁבוּעַ"], ["בחודש", "בְּחֹודֶשׁ"]],
  ...
  buildReviewedSentence({
    ...
    hebrewDistractorPairs: [["סירבתי", "סֵירַבְתִּי"], ["למסלול חדש", "לְמַסְלוּל חָדָשׁ"], ["בחורף", "בַּחֹורֶף"], ["באביב", "בָּאָבִיב"]],
  ...
  buildReviewedSentence({
    ...
    hebrewDistractorPairs: [["במסדר הבוקר", "בְּמִסְדַּר הַבֹּקֶר"], ["המפקדים", "הַמְּפַקְּדִים"], ["איחרו", "אִיחֲרוּ"], ["חיכו", "חִיכּוּ"]],
  ...
  buildReviewedSentence({
    ...
    wordOrderDecision: "fixed",
    hebrew: "מסקנות התחקיר שינו את הנוהל.", hebrewNiqqud: "מַסְקְנוֹת הַתַּחְקִיר שִׁינּוּ אֶת הַנּוֹהַל.",
    english: "The conclusions of the debrief changed the procedure.",
    hebrewTokenPairs: [["מסקנות", "מַסְקְנוֹת"], ["התחקיר", "הַתַּחְקִיר"], ["שינו", "שִׁינּוּ"], ["את הנוהל", "אֶת הַנּוֹהַל"]],
